        ...
        <div class="inner">
            <div class="sub_top_box">
                <div class="sub_top_nav">
                    <span>홈</span><span>참가기업</span><span>참가신청확인</span>
                </div>
                <div class="sub_top_tit">참가신청확인</div>
            </div>
        </div>
    </div>
    <!-- //section -->
            ...
            <div class="sub_tab_box">
                ...
                <div class="optionBox">
                    ...
                    <div class="tabOpt2 tabOption">
                        <div class="tabOptAct">참가신청확인</div>
                        <div class="tabOptSel">
                            <a href="/exhibitor/guide.do">참가기업 안내</a>
                            <a href="/apply/step01.do">참가기업 신청</a>
                            <a class="active" href="/exhibitor/login.do">참가신청확인</a>
    ...
    <div class="login_s padding_tb">
        <div class="inner">
            <div class="login_top_txt">
                경기국제보트쇼에 오신 것을 환영합니다.<br>
                이미 회원가입을 하신 분은 로그인 후 마이페이지로 이동합니다.<br>
                회원으로 가입하신 경우 전시회 및 상담회 참가신청이 가능합니다.<br>
            </div>
            <div class="login_box">
                <div class="login_form">
                    <form id="login_form" name="login_form" action="/mypage/index.do" method="post" onsubmit="return false;">
                        <div class="loginInfo">
                            <p>아이디</p>
                            <input type="text" id="exhibitId" maxlength="10" placeholder="아이디를 입력해 주세요.">
                        </div>
                        <div class="loginInfo">
                            <p>비밀번호</p>
                            <input type="password" id="exhibitPw" placeholder="비밀번호를 입력해 주세요.">
                        </div>
                        <div class="loginInfo">
