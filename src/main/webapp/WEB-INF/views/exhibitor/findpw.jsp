    ...
    <div class="login_s padding_tb">
        <div class="inner">
            <div class="login_top_txt">
                가입시 입력했던 E-mail 주소로 비밀번호를 초기화 할 수 있는 링크를 보내드립니다.<br>
                기업회원의 경우 가입했던 E-mail 주소를 기억하지 못하거나, 담당자가 바뀐 경우 해당 사무국으로 연락 바랍니다.<br>
            </div>
            <div class="login_box">
                <div class="login_form">
                    ...
                    <div class="btnLogin">
                        <a href="javascript:void(0);" onclick="f_pw_init()" class="btnSt01" style="cursor: pointer;">초기화 요청하기</a>
                    </div>
                </div>
            </div>
        </div>
