                ...
                <div class="form_wrap">
                    ...
                    <div class="form_pri">
                        <div class="form_pri_box">
                            ...
                            2. 주관전시회 홈페이지 운영<br>
                            - 위탁받는 자 (수탁자) : 엔플레이어, 마이스엔, 웹스톰, 주식회사 크리에이티브랩 스튜디오<br>
                            ...
                            4. 처리정지 요구<br>
                            5. 개인정보의 본인전송 요구<br>
                            ② 개인정보 본인전송요구권 행사 방법 및 절차<br>
                            - 행사 방법: 정보주체는 개인정보 보호법 시행규칙 별지 제8호의2 서식(개인정보 전송 요구서)을 작성하여 서면 또는 전자우편(이메일 접수처 기재)으로 제출할 수 있습니다.<br>
                            - 제공 방식: 본인 확인 절차를 거친 후, 컴퓨터 등 정보처리장치로 처리 가능한 형태(CSV, Excel 등)로 암호화하여 요청하신 전자우편 등으로 전송합니다.<br>
                            - 처리 기한: 전송 요구를 받은 날로부터 10일 이내에 전송 또는 처리 결과를 통지합니다.  <br>
                            - 거절 사유: 타인의 권리를 침해할 우려가 있거나, 법령상 의무 준수를 위해 필요한 경우 등 「개인정보 보호법 시행령」에 정한 정당한 사유가 있는 경우 전송이 제한되거나 거절될 수 있습니다.<br>
                            - 전송 요구 사전협의 창구 및 문의처: 본인전송요구권 행사와 관련한 대상 항목, 전송 방법, 처리 절차 등에 대한 사전 협의 및 문의는 아래 부서를 통해 신속하게 안내받으실 수 있습니다.<br>
                            <span style="margin-left: 11px;">담당 부서: 전시사업3팀</span><br>
                            <span style="margin-left: 11px;">담당자 : 오병훈 차장</span><br>
                            <span style="margin-left: 11px;">연락처 : 031-995-8777</span><br>
                            <span style="margin-left: 11px;">이메일: sky@kintex.com</span><br>
                            ...
                            ① 이 개인정보 처리방침은 2018. 8. 25부터 적용됩니다.<br>
                            ② 이전의 개인정보 처리방침은 아래에서 확인하실 수 있습니다.<br>
                            - 2018. 4. 12 ~ 2018. 8. 24 적용
                        </div>
                    </div>
                </div>
                <!-- //약관 -->
