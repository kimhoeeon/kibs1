        ...
        <div class="inner">
                    ...
                    <ul class="list1">
                        ...
                        <li class="active">
                            ...
                            <ul class="list2">
                                ...
                                <li class="active"><a href="/apply/step2_7.do">온라인 전시관 신청</a></li>
            ...
            <div class="apply_step">
                ...
                <div class="apply_step_wrap">
                    ...
                    <div class="apply_step_box step2">
                        ...
                        <div class="txt">진행중...<p>(총 <span>6</span>개 중 <span>6</span> 완료)</p></div>
                    </div>
            ...
            <div class="apply_form form_s padding_t" id="apply_s1">
                <div class="inner">
                    ...
                    <div class="form_btn">
                        <a href="/apply/step2_6.do#apply_s" class="form_btn_prev">
                            <div class="big">이전</div>
                            <div class="small">웹 배너 신청</div>
                        </a>
                        <a href="/apply/step2_8.do#apply_s" class="form_btn_next">
