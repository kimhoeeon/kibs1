        ...
        <div class="inner">
            ...
            <div class="form_wrap">
                ...
                <div class="form_pri">
                    ...
                    <div class="form_pri_agree">
                        <label><input type="radio" name="agree1" checked disabled>동의함</label>
                        <label><input type="radio" name="agree1" disabled>동의하지 않음</label>
                    </div>
                </div>
            </div>
            <!-- //약관 -->
            ...
            <div class="form_wrap">
                ...
                <div class="form_pri">
                    ...
                    <div class="form_pri_agree">
                        <label><input type="radio" name="agree2" checked disabled>동의함</label>
                        <label><input type="radio" name="agree2" disabled>동의하지 않음</label>
                    </div>
                </div>
            </div>
            <!-- //약관 -->
            ...
            <div class="form_wrap">
                ...
                <div class="form_pri">
                    ...
                    <div class="form_pri_agree">
                        <label><input type="radio" name="agree3" checked disabled>동의함</label>
                        <label><input type="radio" name="agree3" disabled>동의하지 않음</label>
                    </div>
                </div>
            </div>
            <!-- //약관 -->
                ...
                <div class="form_wrap">
                    ...
                    <ul class="form_box">
                        <li>
                            ...
                            <div class="input">
                                <input type="text" id="name" name="name" value="${info.name}" placeholder="성명을 입력해 주세요." readonly>
                            </div>
                        </li>
                        <li class="w50">
                            <div class="item">
                            ...
                            <div class="input">
                                <input type="tel" id="tel" name="tel" value="${info.tel}" class="onlyTel" maxlength="14" placeholder="숫자만 입력해 주세요. 하이픈(-) 자동 입력">
                            </div>
                        </li>
                        <li class="w50">
                            <div class="item req">
                        ...
                        <li>
                            ...
                            <div class="input email">
                                <input type="text" id="email" name="email" value="${info.email}" placeholder="이메일 입력" class="email_input1">
                                <span>@</span>
                                <input type="text" id="domain" name="domain" value="${info.domain}" placeholder="도메인 입력" class="email_input2">
                        ...
                        <li>
                            <div class="item <c:if test="${info.partGbn eq '바이어'}">req</c:if>">
                                <p>직장명</p>
                            </div>
                            <div class="input companyNameBox" style="flex-wrap: wrap">
                                <input class="companyNameInput" type="text" id="companyName" name="companyName" value="${info.companyName}" placeholder="직장명">
                                <input class="companyNameSh" type="button" value="검색">
                                <input type="text" id="companyAddress" name="companyAddress" value="${info.companyAddress}" placeholder="직장 주소 입력">
                            </div>
                        </li>
                        <li>
                            <div class="item">
                            ...
                            <div class="input check">
                                <label><input type="radio" name="partnerYn" id="Y" value="Y" <c:if test="${info.partnerYn eq 'Y'}">checked</c:if> >있음</label>
                                <label><input type="radio" name="partnerYn" id="N" value="N" <c:if test="${info.partnerYn eq 'N' or info.partnerYn eq null}">checked</c:if> >없음</label>
                    ...
                    <c:forEach var="partner" items="${partnerList}" begin="0" end="${partnerList.size()}" step="1" varStatus="status">
                        <ul class="form_box visitPartnerBox" style="border-top:0;">
                            <li class="form_in_tit">
                                동반자 #<span class="visitPartnerNum">${status.index + 1}</span>
                                <span class="del_btn visitPartnerDel">삭제</span>
                ...
                <div class="form_wrap">
                    ...
                    <ul class="form_box">
                        <li class="w50">
                            ...
                            <div class="input check">
                                <label><input type="radio" name="sex" value="남자" <c:if test="${info.sex eq '남자'}">checked</c:if> >남자</label>
                        ...
                        <li>
                            ...
                            <div class="input check">
                                <label><input type="radio" name="ageGroup" value="10" <c:if test="${info.ageGroup eq '10' or info.ageGroup eq null}">checked</c:if> >10대</label>
                                <label><input type="radio" name="ageGroup" value="20" <c:if test="${info.ageGroup eq '20'}">checked</c:if> >20대</label>
                                <label><input type="radio" name="ageGroup" value="30" <c:if test="${info.ageGroup eq '30'}">checked</c:if> >30대</label>
                                <label><input type="radio" name="ageGroup" value="40" <c:if test="${info.ageGroup eq '40'}">checked</c:if> >40대</label>
                                <label><input type="radio" name="ageGroup" value="50" <c:if test="${info.ageGroup eq '50'}">checked</c:if> >50대</label>
                                <label><input type="radio" name="ageGroup" value="60" <c:if test="${info.ageGroup eq '60'}">checked</c:if> >60대 이상</label>
                            </div>
                        </li>
                        <c:if test="${info.partGbn ne '바이어'}">
                            <li>
                                ...
                                <div class="input check">
                                    <label><input type="checkbox" name="observationGbn" value="조종면허 보유자" <c:if test="${fn:contains(info.observationGbn, '조종면허 보유자')}">checked</c:if> >조종면허 보유자</label>
                                    ...
                                    <label><input type="checkbox" name="observationGbn" value="학생" <c:if test="${fn:contains(info.observationGbn, '학생')}">checked</c:if> >학생</label>
                                    <label><input type="checkbox" name="observationGbn" value="일반관람" <c:if test="${fn:contains(info.observationGbn, '일반관람')}">checked</c:if> >일반관람</label>
                                    <label><input type="checkbox" name="observationGbn" value="기타" <c:if test="${fn:contains(info.observationGbn, '기타')}">checked</c:if> >기타</label>
                        ...
                        <li>
                            ...
                            <div class="input check">
                                <label><input type="checkbox" name="visitPurpose" value="업계동향 파악 및 정보수집" <c:if test="${fn:contains(info.visitPurpose, '업계동향 파악 및 정보수집')}">checked</c:if> >업계동향 파악 및 정보수집</label>
                                <label><input type="checkbox" name="visitPurpose" value="제품구매 및 기술도입 상담" <c:if test="${fn:contains(info.visitPurpose, '제품구매 및 기술도입 상담')}">checked</c:if> >제품구매 및 기술도입 상담</label>
                                <label><input type="checkbox" name="visitPurpose" value="기존 거래업체 방문" <c:if test="${fn:contains(info.visitPurpose, '기존 거래업체 방문')}">checked</c:if> >기존 거래업체 방문</label>
                                <label><input type="checkbox" name="visitPurpose" value="차기 전시회 참가여부 파악" <c:if test="${fn:contains(info.visitPurpose, '차기 전시회 참가여부 파악')}">checked</c:if> >차기 전시회 참가여부 파악</label>
                                <label><input type="checkbox" name="visitPurpose" value="일반관람" <c:if test="${fn:contains(info.visitPurpose, '일반관람')}">checked</c:if> >일반관람</label>
                                <label><input type="checkbox" name="visitPurpose" value="기타" <c:if test="${fn:contains(info.visitPurpose, '기타')}">checked</c:if> >기타</label>
                                <div class="cmnt">복수응답가능</div>
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <div class="input check">
                                <label><input type="checkbox" name="recognizePath" value="뉴스레터" <c:if test="${fn:contains(info.recognizePath, '뉴스레터')}">checked</c:if> >뉴스레터</label>
                                <label><input type="checkbox" name="recognizePath" value="옥외광고물" <c:if test="${fn:contains(info.recognizePath, '옥외광고물')}">checked</c:if> >옥외광고물</label>
                                <label><input type="checkbox" name="recognizePath" value="홈페이지" <c:if test="${fn:contains(info.recognizePath, '홈페이지')}">checked</c:if> >홈페이지</label>
                                <label><input type="checkbox" name="recognizePath" value="전문지" <c:if test="${fn:contains(info.recognizePath, '전문지')}">checked</c:if> >전문지</label>
                                <label><input type="checkbox" name="recognizePath" value="온라인 커뮤니티" <c:if test="${fn:contains(info.recognizePath, '온라인 커뮤니티')}">checked</c:if> >온라인 커뮤니티</label>
                                <label><input type="checkbox" name="recognizePath" value="오프라인매장" <c:if test="${fn:contains(info.recognizePath, '오프라인매장')}">checked</c:if> >오프라인매장</label>
                        ...
                        <li>
                            ...
                            <div class="input check">
                                <label><input type="checkbox" name="preObservationGbn" value="first" <c:if test="${fn:contains(info.preObservationGbn, 'first')}">checked</c:if> >첫 참관</label>
