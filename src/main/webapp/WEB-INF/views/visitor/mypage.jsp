...
<body>
                ...
                <div class="form_wrap">
                    <div class="form_pri">
                        <div class="form_pri_item">
                            &lt;1차 사전등록&gt;<br>
                            - 기간 : 2027년 1월 1일(금) ~ 2027년 2월 14일(일)<br>
                            - 금액 : 무료<br><br>
                            &lt;2차 사전등록&gt;<br>
                            - 기간 : 2027년 2월 15일(월) ~ 2027년 3월 9일(화)<br>
                ...
                <form id="joinForm" name="joinForm" method="post" onsubmit="return false;">
                    ...
                    <div class="form_wrap">
                        ...
                        <ul class="form_box">
                            <li>
                                <div class="input check w-100">
                                    <label><input type="radio" name="eventGbn" value="경기국제보트쇼" <c:if test="${info.eventGbn eq '경기국제보트쇼'}">checked</c:if>>경기국제보트쇼(KIBS)·한국국제낚시박람회(KOFISH)</label>
                                    <label><input type="radio" name="eventGbn" value="코리아서프쇼" <c:if test="${info.eventGbn eq '코리아서프쇼'}">checked</c:if>>코리아서프쇼(KISS)</label>
                                    <label><input type="radio" name="eventGbn" value="해양관광전" <c:if test="${info.eventGbn eq '해양관광전'}">checked</c:if>>해양관광전(KMTS)</label>
                    ...
                    <div class="form_wrap">
                        ...
                        <ul class="form_box">
                            ...
                            <li id="observationGbnDiv" <c:if test="${info.partGbn eq '바이어'}">style="display:none;"</c:if>>
                                <div class="item req">
                                    <p>관람 구분</p>
                                </div>
    ...
    <script>
        $(function(){
            ...
            // 2. 초기 로딩 시: 행사 구분 기본값 설정 (저장된 값이 없을 경우 대비)
