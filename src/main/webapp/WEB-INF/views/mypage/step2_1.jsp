                                ...
                                <div class="form_disc form_ptag">
                                    <div class="form_ptag_box">
                                        <ul class="form_ptag_list">
                                            ...
                                            <%--<li>
                                                <div class="select"><label><input type="checkbox" id="discount7" name="discount" value="500000" onchange="autoDiscountSum(this, '500000');" <c:if test="${info.discountFirst}">checked</c:if> &lt;%&ndash;disabled&ndash;%&gt;></label></div>
