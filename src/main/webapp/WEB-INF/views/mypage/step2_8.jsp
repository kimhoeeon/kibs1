                            ...
                            <ul class="list1">
                                ...
                                <li class="active">
                                    ...
                                    <ul class="list2">
                                        ...
                                        <li class="active"><a href="javascript:void(0);" onclick="f_page_move('/mypage/step2_8.do','${info.seq}')">디렉토리 정보</a></li>
                                    </ul>
                                </li>
                        ...
                        <div class="inner">
                            ...
                            <div class="form_wrap">
                                <ul class="form_guide">
                                    ...
                                    <%--<li>2025 경기국제보트쇼 종료로 인해 <span class="txtRed" style="font-weight: 700;">전시 정보 수정이 불가</span>합니다.</li>--%>
                                </ul>
                            </div>
                            ...
                            <div class="form_btn">
                                <a href="javascript:void(0);" onclick="f_page_move('/mypage/step2_5.do','${info.seq}')" class="form_btn_prev">
                                    <div class="big">이전</div>
                                    <div class="small">웹 배너 신청</div>
                                </a>
                                <a href="javascript:void(0);" onclick="f_mypage_comp('2_8','${info.seq}')" class="form_btn_next">
