                ...
                <div class="inner">
                            ...
                            <ul class="list1">
                                ...
                                <li class="active">
                                    ...
                                    <ul class="list2">
                                        ...
                                        <li class="active"><a href="/mypage/step2_6.do">웹 배너 신청</a></li>
                    ...
                    <div class="my_form form_s">
                        <div class="inner">
                            ...
                            <div class="form_btn">
                                <a href="/mypage/step2_5.do#apply_s" class="form_btn_prev">
                                    <div class="big">이전</div>
                                    <div class="small">경품제공 신청</div>
                                </a>
                                <a href="/mypage/step2_8.do#apply_s" class="form_btn_next">
