                            ...
                            <ul class="list1">
                                ...
                                <li class="active">
                                    ...
                                    <ul class="list2">
                                        ...
                                        <li class="active"><a href="javascript:void(0);" onclick="f_page_move('/mypage/step2_10.do','${info.seq}')">해상전시회 신청</a></li>
                        ...
                        <div class="inner">
                            ...
                            <div class="form_wrap maritime">
                                ...
                                <div class="maritime_cont">
                                    <div class="tit">
                                        <div class="big">
                                            <span>육상(3월, 킨텍스) - 해상(5월, 시흥 거북섬마리나)</span> 연계형 통합 홍보 프로그램_<span>해상전시회</span>
                                        </div>
                                    </div>
                                    <ul>
                                        <li>2026년 5월, <span>경기국제보트쇼 해상전시회 @ 시흥 거북섬마리나</span> 개최</li>
                                        <li>3월 킨텍스 육상전시회와 5월 거북섬마리나 <span>해상전시회를 하나의 연속 프로그램</span>으로 구성</li>
                            ...
                            <div class="form_btn">
                                ...
                                <a href="javascript:void(0);" onclick="f_mypage_comp('2_10','${info.seq}')" class="form_btn_next">
