                ...
                <div class="inner">
                    ...
                    <div class="apply_nav">
                        ...
                        <div class="apply_nav_list">
                            <ul class="list1">
                                <li class="active"><a href="javascript:void(0);" onclick="f_page_move('/mypage/step01.do','${info.seq}')">기본정보</a></li>
                                <li>
                                ...
                                <div class="form_wrap">
                                    ...
                                    <div class="form_pri">
                                        <div class="form_pri_box">
                                            ...
                                            1. 전시자는 참가비 전액을 신청서 제출 후 14일 이내 납입해야 한다. 단, 2027년 1월 5일 이후 참가 신청 시에는 신청과 동시에 참가비를 100% 완납하여야 한다.<br>
                                            ...
                                            - 2027.1.1.~2027.1.18. 취소 시: 총 참가비의 80%를 위약금으로 주관자에게 납부<br>
                                            - 2027.1.19.~ 취소 시: 총 참가비의 100%를 위약금으로 주관자에게 납부<br><br>
