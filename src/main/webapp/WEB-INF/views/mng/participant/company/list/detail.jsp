                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                <!--begin::form-->
                                <form id="participantCompanyModifyForm" name="participantCompanyModifyForm" method="post" onsubmit="return false;">
                                    <%--참가업체 seq 값--%>
                                    <input type="hidden" id="seq" name="seq" value="${info.seq}">
                                    <input type="hidden" id="exSeq" name="exSeq" value="${info.exSeq}">
                                    <!--begin::Basic info-->
                                    <div class="card mb-5 mb-xl-10">
                                        ...
                                        <!--begin::Card header-->
                                        <!--begin::Content-->
                                        <div id="kt_participant_company_info" class="collapse show">
                                            <!--begin::Card body-->
                                    ...
                                    <div class="card mb-5 mb-xl-10">
                                        ...
                                        <div class="card-footer d-flex justify-content-between py-6 px-9">
                                            <div>
                                                <a href="/mng/participant/company/list.do" class="btn btn-info btn-active-light-info" id="kt_list_btn">목록</a>
                                            </div>
                                            <div>
                                                <button type="button" onclick="f_exhibitor_comp_init_set('${info.seq}')" class="btn btn-danger btn-active-light-danger me-2">변경내용취소</button>
                                                <button type="button" onclick="f_participant_company_save('${info.seq}')" class="btn btn-primary btn-active-light-primary" id="kt_save_submit">변경내용저장</button>
                                            </div>
                                        </div>
                                        <!--end::Actions-->
                                    </div>
