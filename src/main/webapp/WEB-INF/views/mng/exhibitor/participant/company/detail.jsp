                                    ...
                                    <c:if test="${info ne null}">
                                        ...
                                        <div class="card mb-5 mb-xl-10">
                                            ...
                                            <div class="card-body border-top p-9">
                                                ...
                                                <div class="row">
                                                    <!--begin::Label-->
                                                    <label class="col-lg-2 col-form-label fw-semibold fs-6">참가비 수납 상태</label>
                                                    <!--end::Label-->
                                                    <!--begin::Col-->
                                                    <div class="col-lg-10">
                                        ...
                                        <div class="card mb-5 mb-xl-10">
                                            ...
                                            <div id="kt_approval_info">
                                                ...
                                                <div class="card-body border-top p-9">
                                                    ...
                                                    <div class="row mb-6">
                                                        <!--begin::Label-->
                                                        <label class="col-lg-2 col-form-label fw-semibold fs-6">참가상태</label>
                                                        <!--end::Label-->
                                                        <!--begin::Col-->
                                                        <div class="col-lg-10">
                                                    ...
                                                    <div class="row mb-6">
                                                        <!--begin::Label-->
                                                        <label class="col-lg-2 col-form-label fw-semibold fs-6">신청폼작성여부</label>
                                                        <!--end::Label-->
                                                        <!--begin::Col-->
                                                        <div class="col-lg-10">
                                                    ...
                                                    <div class="row mb-6">
                                                        <!--begin::Label-->
                                                        <label class="col-lg-2 col-form-label fw-semibold fs-6">승인구분</label>
                                                        <!--end::Label-->
                                                        <!--begin::Col-->
                                                        <div class="col-lg-10">
                                        ...
                                        <div class="card mb-5 mb-xl-10">
                                            ...
                                            <div id="kt_approval_new_info">
                                                ...
                                                <div class="card-body border-top p-9">
                                                    ...
                                                    <div class="row mb-6">
                                                        <!--begin::Label-->
                                                        <label class="col-lg-2 col-form-label fw-semibold fs-6 required">아이디</label>
                                                        <!--end::Label-->
                                                        <!--begin::Col-->
                                                        <div class="col-lg-10">
                                    ...
                                    <div class="card mb-5 mb-xl-10">
                                        ...
                                        <div id="kt_exhibitor_info">
                                            ...
                                            <div class="card-body border-top p-9">
                                                ...
                                                <div class="row mb-6">
                                                    <!--begin::Label-->
                                                    <label class="col-lg-2 col-form-label fw-semibold fs-6">성명</label>
                                                    <!--end::Label-->
                                                    <!--begin::Col-->
                                                    <div class="col-lg-10">
                                                ...
                                                <div class="row mb-6">
                                                    <!--begin::Label-->
                                                    <label class="col-lg-2 col-form-label fw-semibold fs-6">직위</label>
                                                    <!--end::Label-->
                                                    <!--begin::Col-->
                                                    <div class="col-lg-10">
                                                ...
                                                <div class="row mb-6">
                                                    <!--begin::Label-->
                                                    <label class="col-lg-2 col-form-label fw-semibold fs-6">E-mail 마케팅정보 수신동의</label>
                                                    <!--end::Label-->
                                                    <!--begin::Col-->
                                                    <div class="col-lg-10">
                                    ...
                                    <div class="card mb-5 mb-xl-10">
                                        ...
                                        <div id="kt_company_info">
                                            ...
                                            <div class="card-body border-top p-9">
                                                ...
                                                <div class="row mb-6">
                                                    <!--begin::Label-->
                                                    <label class="col-lg-2 col-form-label fw-semibold fs-6">공장 주소</label>
                                                    <!--end::Label-->
                                                    <!--begin::Col-->
                                                    <div class="col-lg-10">
                                                        <!--begin::Row-->
                                                ...
                                                <div class="row mb-6">
                                                    <!--begin::Label-->
                                                    <label class="col-lg-2 col-form-label fw-semibold fs-6 required">산업 분류</label>
                                                    <!--end::Label-->
                                                    <!--begin::Col-->
                                                    <div class="col-lg-10">
                                                        <!--begin::Row-->
                                                ...
                                                <div class="row mb-6">
                                                    <!--begin::Label-->
                                                    <label class="col-lg-2 col-form-label fw-semibold fs-6 required">임직원 수</label>
                                                    <!--end::Label-->
                                                    <!--begin::Col-->
                                                    <div class="col-lg-10">
                                                ...
                                                <c:if test="${companyLicenseFile ne null and not empty companyLicenseFile}">
                                                    ...
                                                    <div class="row mb-6">
                                                        <!--begin::Label-->
                                                        <label class="col-lg-2 col-form-label fw-semibold fs-6">사업자등록증 파일목록</label>
                                                        <!--end::Label-->
                                                        <!--begin::Col-->
                                                        <div class="col-lg-10">
                                                            <ul>
                                                ...
                                                <div class="row mb-8">
                                                    <!--begin::Label-->
                                                    <label class="col-lg-2 col-form-label fw-semibold fs-6 required">한국해양레저산업협회 회원사 여부</label>
                                                    <!--begin::Label-->
                                                    <!--begin::Label-->
                                    ...
                                    <div class="card mb-5 mb-xl-10">
                                        ...
                                        <div id="kt_detail_info">
                                            ...
                                            <div class="card-body border-top p-9">
                                                ...
                                                <div class="row mb-6">
                                                    <!--begin::Label-->
                                                    <label class="col-lg-2 col-form-label fw-semibold fs-6">KIBS 참가목적</label>
                                                    <!--end::Label-->
                                                    <!--begin::Col-->
                                                    <div class="col-lg-10">
                                                        <!--begin::Row-->
                                                ...
                                                <c:if test="${logoFile ne null and not empty logoFile}">
                                                    ...
                                                    <div class="row mb-6">
                                                        <!--begin::Label-->
                                                        <label class="col-lg-2 col-form-label fw-semibold fs-6">로고 파일목록</label>
                                                        <!--end::Label-->
                                                        <!--begin::Col-->
                                                        <div class="col-lg-10">
                                                            <ul>
                                                ...
                                                <c:if test="${promotionImageFileList ne null and not empty promotionImageFileList}">
                                                    ...
                                                    <div class="row">
                                                        <!--begin::Label-->
                                                        <label class="col-lg-2 col-form-label fw-semibold fs-6">홍보 이미지 파일목록</label>
                                                        <!--end::Label-->
                                                        <!--begin::Col-->
                                                        <div class="col-lg-10">
                                                            <ul>
