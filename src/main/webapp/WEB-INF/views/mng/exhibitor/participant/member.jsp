...
<c:if test="${sessionScope.get('status') eq 'logon'}">
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion hover show">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link active" href="/mng/exhibitor/participant/member.do">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                                <span class="menu-title">회원 목록</span>
                        ...
                        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <button type="button" onclick="f_excel_export('kt_member_table', '회원')" class="btn btn-success btn-active-light-success" data-kt-export="excel" data-kt-menu-placement="bottom-end">
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                ...
                                <div class="card card-flush">
                                        ...
                                        <div class="card-title w-100">
                                            ...
                                            <div class="w-100 mw-175px">
                                                ...
                                                <select id="search_box" class="form-select form-select-solid" data-control="select2"
                                                    ...
                                                    <option value="nameKo" selected>이름/회사명(국문)</option>
                                                    <option value="nameEn">이름/회사명(영문)</option>
                                                </select>
                                                <!--end::Select2-->
                                            </div>
                                            <%--end::검색구분--%>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <button type="button" onclick="f_member_search()" class="btn btn-primary me-5">Search</button>
                                        ...
                                        <div class="card-toolbar flex-row-fluid gap-5">
                                            ...
                                            <div class="w-100 mw-150px">
                                                ...
                                                <select id="condition_gbn" class="form-select form-select-solid" data-control="select2"
                                                        data-hide-search="true" data-allow-clear="true"
                                                        data-placeholder="- 유형 -" onchange="f_search_condition_box_change()">
                                                    <option></option>
                                                    <option value="" disabled>- 유형 -</option>
                                                    <option value="company">참가업체</option>
                                                    <option value="visitor">참관객</option>
                                                </select>
                                                <!--end::Select2-->
                                            </div>
                                            <%--end::유형--%>
                                            ...
                                            <div class="w-100 mw-250px">
                                                <!--begin::Select2-->
                                                <select id="condition_status" class="form-select form-select-solid" data-control="select2"
                                                        data-hide-search="true" data-allow-clear="true"
                                                        data-placeholder="- 상태 -" onchange="f_search_condition_box_change()">
                                                    <option></option>
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <!--begin::Table-->
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_member_table">
                                            <thead>
                                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                    <th class="text-center min-w-30px">#</th>
                                                    <th>SEQ</th>
                                                    <th class="text-center min-w-85px">유형</th>
                                                    <th class="text-center min-w-100px">상태</th>
                                                    <th>ID</th>
                                                    <th class="text-center min-w-150px">이름/회사명(국문)</th>
                                                    <th class="text-center min-w-150px">이름/회사명(영문)</th>
                                                    <th class="text-center min-w-150px">이메일</th>
                                                    <th class="text-center min-w-100px">가입일시</th>
    ...
    <script src="/js/custom/member.js?ver=<%=System.currentTimeMillis()%>"></script>
