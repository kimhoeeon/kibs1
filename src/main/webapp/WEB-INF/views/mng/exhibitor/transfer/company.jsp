                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion hover show">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link active" href="/mng/exhibitor/transfer/company.do">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                        ...
                        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <button type="button" onclick="f_excel_export('kt_exhibitor_transfer_company_table', '지난행사_전시업체')" class="btn btn-success btn-active-light-success" data-kt-export="excel" data-kt-menu-placement="bottom-end">
                                    ...
                                    <!--begin::Export dropdown-->
                                    <button type="button" onclick="f_transfer_company_excel_export()" class="btn btn-dark btn-active-light-dark" data-kt-menu-placement="bottom-end">
                                        <i class="ki-duotone ki-exit-down fs-2">
                                            <span class="path1"></span>
                                            <span class="path2"></span>
                                        </i>지난행사 전시업체 상세 다운로드</button>
                                    <!--end::Export dropdown-->
                                </div>
                                <!--end::Actions-->
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                ...
                                <div class="card card-flush">
                                    ...
                                    <div class="card-header align-items-center py-5 gap-2">
                                        ...
                                        <div class="card-title w-100">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <button type="button" onclick="f_transfer_company_search()" class="btn btn-primary me-5">Search</button>
                                        ...
                                        <div class="card-toolbar flex-row-fluid gap-5">
                                            ...
                                            <div class="w-100 mw-200px">
                                                ...
                                                <select id="lang" class="form-select form-select-solid" data-control="select2"
                                                        data-hide-search="true"
                                                        data-placeholder="- 참가신청 언어 -" onchange="f_transfer_search_condition_box_change()">
                                                    <option></option>
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <!--begin::Table-->
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_exhibitor_transfer_company_table">
                                            <thead>
                                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                <th class="text-center min-w-30px">#</th>
                                                <th>SEQ</th>
                                                <th class="text-center min-w-100px">연도</th>
                                                <th class="text-center min-w-100px">회사명(국문)</th>
                                                <th class="text-center min-w-100px">회사명(영문)</th>
                                                <th class="text-center min-w-200px">회사명</th>
                                                <th class="text-center min-w-100px">사업자등록번호</th>
                                                <th class="text-center min-w-100px">등록일</th>
