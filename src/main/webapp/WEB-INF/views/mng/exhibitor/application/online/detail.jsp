                                ...
                                <form id="onlineForm" name="onlineForm" method="post" onsubmit="return false;">
                                                            ...
                                                            <div class="row mb-6">
                                                                ...
                                                                <div class="col-lg-8">
                                                                    ...
                                                                    <div class="row">
                                                                        <!--begin::Col-->
                                                                        <div class="col-lg-6">
                                                                            <input type="text" name="productNameKo" class="form-control form-control-lg form-control-solid-bg" placeholder="국문" value="${online.productNameKo}" disabled/>
                                                                        </div>
                                                                        <!--end::Col-->
                                                                        <!--begin::Col-->
                                                                        <div class="col-lg-6">
                                                                            <input type="text" name="productNameEn" class="form-control form-control-lg form-control-solid-bg" placeholder="영문" value="${online.productNameEn}" disabled/>
                                                                        </div>
                                                                        <!--end::Col-->
                                                                    </div>
                                                                    <!--end::Row-->
                                    ...
                                    <div class="card mb-5 mb-xl-10">
                                        ...
                                        <div class="card-footer d-flex justify-content-between py-6 px-9">
                                            <div>
                                                <a href="/mng/exhibitor/application/online.do" class="btn btn-info btn-active-light-info cursor-pointer">목록</a>
                                            </div>
                                            <div>
