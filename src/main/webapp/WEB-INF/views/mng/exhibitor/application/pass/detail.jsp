...
<c:if test="${status eq 'logon'}">
                                ...
                                <form id="passForm" name="passForm" method="post" onsubmit="return false;">
                                    ...
                                    <div class="card mb-5 mb-xl-10">
                                        ...
                                        <div class="card-footer d-flex justify-content-between py-6 px-9">
                                            <div>
                                                <a href="/mng/exhibitor/application/pass.do" class="btn btn-info btn-active-light-info cursor-pointer">목록</a>
                                            </div>
                                            <div>
                                                <button type="button" onclick="f_application_pass_modify_init_set('${exSeq}')" class="btn btn-danger btn-active-light-danger me-2">변경내용취소</button>
                                                <button type="button" onclick="f_application_pass_save('${exSeq}')" class="btn btn-primary btn-active-light-primary">변경내용저장</button>
                                            </div>
                                        </div>
                                        <!--end::Actions-->
                                    </div>
    ...
    <script src="/js/custom/pass.js?ver=<%=System.currentTimeMillis()%>"></script>
    <!--end::Custom Javascript-->
