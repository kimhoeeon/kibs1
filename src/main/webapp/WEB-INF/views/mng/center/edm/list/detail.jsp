...
<c:if test="${sessionScope.get('status') eq 'logon'}">
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion hover show">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link active" href="/mng/center/edm/list.do">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                                <span class="menu-title">메일 발송 & 이력</span>
                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">eDM 관리</li>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item">
                                            <span class="bullet bg-gray-400 w-5px h-2px"></span>
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">메일 발송 & 이력</li>
                                        <!--end::Item-->
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                <!--begin::form-->
                                <form id="edm_mail_form" method="post" onsubmit="return false;">
                                    ...
                                    <div class="card card-flush mb-5 mb-xl-10">
                                        ...
                                        <div class="card-header align-items-center py-5 gap-2">
                                            ...
                                            <div class="card-title w-100">
                                                ...
                                                <div class="ms-auto">
                                                    <!--begin::글쓰기-->
                                                    <a href="/file/edm/eDM_mail_upload_excel_sample.xlsx" class="btn btn-success ms-auto" download>
                                                        <i class="ki-duotone ki-exit-down fs-2">
                                                            <span class="path1"></span>
                                                            <span class="path2"></span>
                                                        </i>Excel Sample Download</a>
                                                    <!--end::글쓰기-->
                                                </div>
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="fw-bold"><span class="mr10">업로드 건수</span><span id="search_cnt" style="color: #009ef7;">0</span> 개</div>
                                            <!--begin::Table-->
                                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_center_edm_upload_table">
                                                <thead>
                                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                    <th class="text-center min-w-50px">#</th>
                                                    <th class="text-center">ID</th>
                                                    <th class="text-center min-w-200px">메일주소</th>
                                    ...
                                    <div class="card mb-5 mb-xl-10">
                                        ...
                                        <div class="card-header border-0">
                                            ...
                                            <div class="card-title m-0">
                                                <h3 class="fw-bold m-0">메일 내용 작성</h3>
                                            </div>
                                            <!--end::Card title-->
                                        </div>
                                        <!--end::Card header-->
                                        ...
                                        <div class="card-body border-top p-9">
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-3 col-form-label fw-semibold fs-6">제목</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-9">
                                                    <input type="text" id="title" name="title" class="form-control form-control-lg form-control-solid-bg" placeholder="제목"/>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="row mb-6<%-- h-550px--%>">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-9">
                                                    <div id="quill_editor_content" style="height: 500px; min-height: 500px; resize: vertical; overflow-y: auto;"<%--class="h-500px"--%>></div>
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-3 col-form-label fw-semibold fs-6">첨부파일</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-9">
                                                    <!--begin::Excel import-->
                                                    ...
                                                    <div class="form-text text-muted">
                                                        <i class="ki-duotone ki-information-2">
                                                            ...
                                                            <i class="path2"></i>
                                                            <i class="path3"></i>
                                                        </i> 첨부파일은 최대 5개까지만 첨부 가능합니다.<br>
                                                        <i class="ki-duotone ki-information-2">
                                                            <i class="path1"></i>
                                                            <i class="path2"></i>
                                                            <i class="path3"></i>
                                                        </i> 첨부파일은 전체 용량이 10MB 이하여야 발송 가능합니다.
                                                    </div>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            ...
                                            <div class="row">
                                                <!--begin::Label-->
                                                <label class="col-lg-3 col-form-label fw-semibold fs-6">첨부파일목록</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-9">
                                                    <!--begin::ul-->
                                ...
                                <div class="card mb-5 mb-xl-10">
                                    ...
                                    <div class="card-footer d-flex justify-content-between py-6 px-9">
                                        <div>
                                            <a href="/mng/center/edm/list.do" class="btn btn-info btn-active-light-info" id="kt_list_btn">목록</a>
                                        </div>
                                        <div>
                                            <button type="button" onclick="f_edm_detail_init_set()" class="btn btn-danger btn-active-light-danger me-2">작성내용 초기화</button>
                                            <button type="button" onclick="f_edm_detail_mail_send()" class="btn btn-primary btn-active-light-primary" id="kt_save_submit">메일 발송</button>
                                        </div>
                                    </div>
                                    <!--end::Actions-->
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body py-lg-10 px-lg-10">
                    ...
                    <div class="col-lg-12 d-flex justify-content-center">
                        ...
                        <div class="ms-10">
                            <!--begin::File upload-->
                            <a onclick="f_mail_file_upload('eDM','modal_file_upload_form','mail')" class="btn btn-primary">업로드</a>
                            <!--end::File upload-->
                        </div>
                        <!--end::Col-->
                    </div>
    ...
    <script src="/js/custom/edm.js?ver=<%=System.currentTimeMillis()%>"></script>
    <!--end::Custom Javascript-->
