                                    ...
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown p-0">
                                        ...
                                        <div class="menu-active-bg px-4 px-lg-0">
                                            ...
                                            <div class="tab-content py-4 py-lg-8 px-lg-7">
                                                ...
                                                <!--end:Tab pane-->
                                                <!--begin:Tab pane-->
                                                <div class="tab-pane active w-lg-300px" id="kt_app_header_menu_pages_document">
                                                    <!--begin:Row-->
                                                    <div class="row">
                                                        <!--begin:Col-->
                                                        <div class="col-lg-12 mb-6 mb-lg-0">
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion hover show">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link active" href="/mng/center/document/download.do">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                                <span class="menu-title">파일 다운로드 내역</span>
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <!--end::Item-->
                                        <%--<!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">나의 서류함</li>
                                        <!--end::Item-->--%>
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item">
                                            <span class="bullet bg-gray-400 w-5px h-2px"></span>
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">파일 다운로드 내역</li>
                                        <!--end::Item-->
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                ...
                                <div class="card card-flush">
                                    ...
                                    <div class="card-header align-items-center py-5 gap-2">
                                        <span class="w-100 fw-bold text-white" style="background-color: #009ef7;">※Attention!※ 파일은 생성일자로부터 30일까지만 보관됩니다.</span>
                                    </div>
                                    <!--end::Card header-->
                                    <!--begin::Card body-->
                                    <div class="card-body pt-0">
                                        <div class="fw-bold"><span class="mr10">검색결과</span><span style="color: #009ef7;">22</span> 개</div>
                                        <!--begin::Table-->
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_center_document_download_table">
                                            <thead>
                                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                    <%--<th class="w-10px pe-2">
                                                        <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                                            <input class="form-check-input" type="checkbox" data-kt-check="true"
                                                                   data-kt-check-target="#kt_center_document_download_table .form-check-input" value="1"/>
                                                        </div>
                                                    </th>--%>
                                                    <th class="text-center min-w-50px">No.</th>
                                                    <th class="text-center min-w-50px">유형</th>
                                                    <th class="text-center min-w-100px">메뉴명</th>
                                                    <th class="text-center min-w-325px">파일명</th>
                                                    <th class="text-center min-w-150px">파일 생성일자</th>
                                                    <th class="text-center min-w-150px">마지막 다운로드일자</th>
                                                    <th class="text-center min-w-75px">생성 유저명</th>
                                                    <th class="text-center min-w-40px">내려받기</th>
                                                    <th class="text-center min-w-40px">삭제</th>
                                                </tr>
                                            </thead>
                                            <tbody class="fw-semibold text-gray-600">
                                                <tr>
                                                    <td class="text-center pe-0">2</td>
                                                    <td class="text-center pe-0">Excel</td>
                                                    <td class="text-center pe-0">전시업체 목록</td>
                                                    <td class="text-center pe-0">KIBS 2025_exhibitor_list_20230713230138.xlsx</td>
                                                    <td class="text-center pe-0">1970-01-01 00:00:00</td>
                                                    <td class="text-center pe-0">1970-01-01 00:00:00</td>
                                                    <td class="text-center pe-0">admin</td>
                                                    <td class="text-center pe-0"><a href=""><i class="ki-solid ki-file-down fs-2hx text-success"></i></a></td>
                                                    <td class="text-center pe-0"><a href=""><i class="ki-solid ki-cross-square fs-2hx text-danger"></i></a></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <!--end::Table-->
