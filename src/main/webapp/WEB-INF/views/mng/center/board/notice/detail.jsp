...
<c:if test="${sessionScope.get('status') eq 'logon'}">
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion hover show">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link active" href="/mng/center/board/notice.do">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                                <span class="menu-title">공지사항</span>
                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                ...
                                <div class="card mb-5 mb-xl-10">
                                    <!--begin::form-->
                                    <form id="boardNoticeForm" method="post" onsubmit="return false;">
                                        <%--공지사항 ID 값--%>
                                        <input type="hidden" id="userId" name="id" value="${info.id}">
                                        <!--begin::Card header-->
                                                ...
                                                <div class="col-lg-10">
                                                    <ul id="uploadFileList">
                                                        <c:forEach var="file" items="${fileList}">
                                                            <li class="mb-4">
                                                                <c:if test="${fn:containsIgnoreCase(file.fullFileName,'jpg') or fn:containsIgnoreCase(file.fullFileName,'png')}">
                                ...
                                <div class="card mb-5 mb-xl-10">
                                    ...
                                    <div class="card-footer d-flex justify-content-between py-6 px-9">
                                        <div>
                                            <a href="/mng/center/board/notice.do" class="btn btn-info btn-active-light-info" id="kt_list_btn">목록</a>
                                        </div>
                                        <div>
                                            <button type="button" onclick="f_board_notice_modify_init_set('${info.id}')" class="btn btn-danger btn-active-light-danger">변경내용취소</button>
                                            <button type="button" onclick="f_board_notice_temp_save('${info.id}')" class="btn btn-secondary btn-active-light-secondary ms-2 me-2">임시저장</button>
                                            <button type="button" onclick="f_board_notice_save('${info.id}')" class="btn btn-primary btn-active-light-primary" id="kt_save_submit">변경내용저장</button>
                                        </div>
                                    </div>
                                    <!--end::Actions-->
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body py-lg-10 px-lg-10">
                    ...
                    <div class="col-lg-12 d-flex justify-content-center">
                        ...
                        <div class="ms-10">
                            <!--begin::File upload-->
                            <a onclick="f_attach_file_upload('${info.id}','modal_file_upload_form','center/board/notice')" class="btn btn-primary">업로드</a>
                            <!--end::File upload-->
                        </div>
                        <!--end::Col-->
                    </div>
    ...
    <script src="/js/custom/centerBoard.js?ver=<%=System.currentTimeMillis()%>"></script>
    <!--end::Custom Javascript-->
