...
<c:if test="${sessionScope.get('status') eq 'logon'}">
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion hover show">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link active" href="/mng/center/board/newsletter_en.do">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                                <span class="menu-title">News letters</span>
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">News letters</li>
                                        <!--end::Item-->
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    <!--begin::Export export-->
                                    <button type="button" onclick="f_excel_export('kt_center_board_newsletter_en_table', '뉴스레터_영문')" class="btn btn-success btn-active-light-success" data-kt-export="excel" data-kt-menu-placement="bottom-end">
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                ...
                                <div class="card card-flush">
                                    ...
                                    <div class="card-header align-items-center py-5 gap-2">
                                        ...
                                        <div class="card-title w-100">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <button type="button" onclick="f_board_newsletter_en_search()" class="btn btn-primary me-5">Search</button>
                                            </div>
                                            <!--end:Action-->
                                            <div class="ms-auto">
                                                <!--begin::글쓰기-->
                                                <a href="/mng/center/board/newsletter/detail.do?lang=EN&seq=" class="btn btn-primary ms-auto">글쓰기</a>
                                                <!--end::글쓰기-->
                                            </div>
                                        </div>
                                        <!--end::Card title-->
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <!--begin::Table-->
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_center_board_newsletter_en_table">
                                            <thead>
    ...
    <script src="/js/custom/newsletterEn.js?ver=<%=System.currentTimeMillis()%>"></script>
