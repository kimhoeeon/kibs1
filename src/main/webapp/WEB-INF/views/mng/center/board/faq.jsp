...
<c:if test="${sessionScope.get('status') eq 'logon'}">
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion hover show">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link active" href="/mng/center/board/faq.do">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                                <span class="menu-title">FAQ</span>
                        ...
                        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <button type="button" onclick="f_excel_export('kt_center_board_faq_table', 'FAQ')" class="btn btn-success btn-active-light-success" data-kt-export="excel" data-kt-menu-placement="bottom-end">
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                ...
                                <div class="card card-flush">
                                    ...
                                    <div class="card-header align-items-center py-5 gap-2">
                                        ...
                                        <div class="card-title w-100">
                                            ...
                                            <div class="w-100 mw-150px">
                                                <!--begin::Select2-->
                                                <select id="search_box" class="form-select form-select-solid" data-control="select2" aria-label="- 언어 -" data-placeholder="- 언어 -" data-hide-search="true">
                                                    <option></option>
                                        ...
                                        <div class="card-toolbar flex-row-fluid gap-5">
                                            ...
                                            <div class="w-100 mw-200px">
                                                <!--begin::Select2-->
                                                <select id="notice_gbn" class="form-select form-select-solid" data-control="select2"
                                                        data-hide-search="true" data-placeholder="- 구분 -">
                                                    <option></option>
                                                    <option disabled>- 구분 -</option>
                                                    <option value="E">참가업체</option>
                                                    <option value="V">참관객</option>
                                                </select>
                                                <!--end::Select2-->
                                            </div>
                                            <%--end::참석여부--%>
                                            ...
                                            <!--begin::글쓰기 등록-->
                                            <a href="/mng/center/board/faq/detail.do?seq=" class="btn btn-primary ms-auto">글쓰기</a>
                                            <!--end::글쓰기 등록-->
                                        </div>
                                        <!--end::Card toolbar-->
                                    </div>
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <!--begin::Table-->
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_center_board_faq_table">
                                            <thead>
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-lg form-control-solid-bg mb-2" id="md_notice_gbn" placeholder="구분" readonly>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
    ...
    <script src="/js/custom/faq.js?ver=<%=System.currentTimeMillis()%>"></script>
