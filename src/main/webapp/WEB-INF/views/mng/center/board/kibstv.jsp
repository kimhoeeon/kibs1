...
<c:if test="${sessionScope.get('status') eq 'logon'}">
                                    ...
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown p-0">
                                        ...
                                        <div class="menu-active-bg px-4 px-lg-0">
                                            ...
                                            <div class="tab-content py-4 py-lg-8 px-lg-7">
                                                <!--begin:Tab pane-->
                                                <div class="tab-pane active w-lg-350px" id="kt_app_header_menu_pages_visitor">
                                                    <!--begin:Row-->
                                                    <div class="row">
                                                        <!--begin:Col-->
                                ...
                                <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                    ...
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown p-0">
                                        ...
                                        <div class="menu-active-bg px-4 px-lg-0">
                                            ...
                                            <div class="tab-content py-4 py-lg-8 px-lg-7">
                                                <!--begin:Tab pane-->
                                                <div class="tab-pane w-lg-250px" id="kt_app_header_menu_pages_product">
                                                    <!--begin:Row-->
                                                    <div class="row">
                                                        <!--begin:Col-->
                                                        <div class="col-lg-12 mb-6 mb-lg-0">
                                                ...
                                                <!--end:Tab pane-->
                                                <!--begin:Tab pane-->
                                                <div class="tab-pane active w-lg-250px" id="kt_app_header_menu_pages_company">
                                                    <!--begin:Row-->
                                                    <div class="row">
                                                        <!--begin:Col-->
                                                        <div class="col-lg-12 mb-6 mb-lg-0">
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion hover show">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link active" href="/mng/center/board/kibstv.do">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">KIBS Tube</span>
                        ...
                        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <button type="button" onclick="f_excel_export('kt_center_board_kibstv_table', 'KIBS_TV')" class="btn btn-success btn-active-light-success" data-kt-export="excel" data-kt-menu-placement="bottom-end">
                                ...
                                <div class="card card-flush">
                                    ...
                                    <div class="card-header align-items-center py-5 gap-2">
                                        ...
                                        <div class="card-title w-100">
                                            ...
                                            <div class="w-100 mw-150px">
                                                ...
                                                <select id="search_box" class="form-select form-select-solid" data-control="select2"
                                                        aria-label="- 언어 -" data-placeholder="- 언어 -" data-hide-search="true" data-allow-clear="true">
                                                    <option></option>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <button type="button" onclick="f_board_kibstv_search()" class="btn btn-primary me-5">Search</button>
                                            </div>
                                            <!--end:Action-->
                                            <div class="ms-auto">
                                                <!--begin::글쓰기-->
                                                <a href="/mng/center/board/kibstv/detail.do?seq=" class="btn btn-primary ms-auto">글쓰기</a>
                                                <!--end::글쓰기-->
                                            </div>
                                        </div>
                                        <!--end::Card title-->
                                        ...
                                        <div class="card-toolbar flex-row-fluid gap-5">
                                            <%--begin::카테고리--%>
                                            <div class="w-100 mw-375px">
                                                <!--begin::Select2-->
                                                <select id="search_category" class="form-select form-select-solid" data-control="select2"
                                                        aria-label="- 카테고리 -" data-placeholder="- 카테고리 -" data-hide-search="true" data-allow-clear="true"
                                                        onchange="f_board_kibstv_search()">
                                                    <option></option>
                                                    ...
                                                    <option value="숏츠">숏츠 [Shorts]</option>
                                                    <option value="마린리뷰쇼">마린리뷰쇼 [Marine Review]</option>
                                                    <option value="해양레저 다이어리">해양레저 다이어리 [Marine Leisure Diary]</option>
                                                    <option value="보트클래스">보트클래스 [Boat Class]</option>
                                                    <option value="렛츠고 보트피싱">렛츠고 보트피싱 [Let's Go Fishing]</option>
                                                    <option value="참가기업 영상">참가기업 영상 [Exhibitors Video]</option>
                                                    <option value="2018 이전 영상">2018 이전 영상 [Before 2018]</option>
                                                </select>
                                                <!--end::Select2-->
                                            </div>
                                            <%--end::카테고리--%>
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <!--begin::Table-->
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_center_board_kibstv_table">
                                            <thead>
                                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                ...
                                                <th class="text-center min-w-125px">카테고리</th>
        ...
        <div class="modal-dialog modal-dialog-centered mw-1000px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header" style="background-color: #1e1e2d;">
                    <!--begin::Modal title-->
                    <h2 style="color: #FFFFFF;">KIBS Tube 상세보기</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <select id="md_lang" class="form-select form-select-solid" data-placeholder="- 언어 -" disabled>
                                    <option></option>
                                ...
                                <div class="d-flex flex-wrap">
                                    <div class="form-check form-check-custom form-check-lg mb-3 mr15">
                                        <input class="form-check-input form-control-solid-bg"
                                               type="checkbox" id="md_site_gbn" value="홈페이지" disabled/>
                                        <label class="form-check-label text-hover-primary" for="md_site_gbn">
                                            홈페이지에 보이기
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div<%-- class="mb-10"--%>>
                                <!--begin::Label-->
                                <label for="md_youtube_url" class="form-label">YouTube 주소</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <div class="input-group mb-5">
                                    <span class="input-group-text" id="base_url">https://www.youtube.com/watch?v=</span>
                                    <input type="text" class="form-control form-control-lg form-control-solid-bg " id="md_youtube_url" aria-describedby="base_url" readonly/>
                                </div>
                                <!--end::Input-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">※ YouTube 주소를 붙여넣으면 동영상 ID로 자동 변환됩니다. (YouTube Shorts 주소 제외)</div>
                                <!--end::Description-->
                            </div>
                            <!--end::Input group-->
                        </div>
    ...
    <script src="/js/custom/kibstv.js?ver=<%=System.currentTimeMillis()%>"></script>
