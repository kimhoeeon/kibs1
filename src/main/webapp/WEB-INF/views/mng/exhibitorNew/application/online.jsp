...
<c:if test="${sessionScope.get('status') eq 'logon'}">
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion hover show">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link active" href="/mng/exhibitorNew/application/online.do">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">온라인 전시관</span>
                        ...
                        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <button type="button" onclick="f_excel_export('kt_exhibitor_application_online_new_table', '온라인전시관')" class="btn btn-success btn-active-light-success" data-kt-export="excel" data-kt-menu-placement="bottom-end">
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                ...
                                <div class="card card-flush">
                                    ...
                                    <div class="card-header align-items-center py-5 gap-2">
                                        ...
                                        <div class="card-title w-100">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <button type="button" onclick="f_application_online_new_search()" class="btn btn-primary me-5">Search</button>
                                            </div>
                                            <!--end:Action-->

                                            <!--begin::검색조건 초기화-->
                                            <button type="button" onclick="f_application_online_new_search_condition_init()" class="btn btn-secondary">
                                        ...
                                        <div class="card-toolbar flex-row-fluid gap-5">
                                            ...
                                            <div class="w-100 mw-175px">
                                                <!--begin::Select2-->
                                                <select id="company_online_view_yn" class="form-select form-select-solid" data-control="select2"
                                                        data-hide-search="true" data-allow-clear="true"
                                            ...
                                            <!--begin::노출/미노출버튼-->
                                            <button type="button" id="online_view_yn_btn" class="btn btn-info ms-auto d-flex align-items-center">
                                                <i class="ki-duotone ki-arrows-circle fs-3">
                                                    <i class="path1"></i>
                                                    <i class="path2"></i>
                                                </i> 노출 상태 변경</button>
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <!--begin::Table-->
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_exhibitor_application_online_new_table">
                                            <thead>
                                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                <th class="text-center min-w-50px">번호</th>
                                                <th>SEQ</th>
                                                <th class="text-center min-w-50px">노출여부</th>
                                                <th class="text-center min-w-100px">참가년도</th>
                                                <th class="text-center min-w-125px">회사명</th>
                                                <th>companyNameEn</th>
                                                <th class="text-center min-w-125px">참가분야</th>
                                                <th class="text-center min-w-125px">제품분류</th>
    ...
    <script src="/js/custom/online_new.js?ver=<%=System.currentTimeMillis()%>"></script>
