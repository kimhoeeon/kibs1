                                    ...
                                    <div class="card-header align-items-center py-5 gap-2">
                                        ...
                                        <div class="card-title w-100">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <button type="button" onclick="f_application_product_new_search()" class="btn btn-primary me-5">Search</button>
                                            </div>
                                            <!--end:Action-->

                                            <!--begin::검색조건 초기화-->
                                            <button type="button" onclick="f_application_product_new_search_condition_init()" class="btn btn-secondary">
