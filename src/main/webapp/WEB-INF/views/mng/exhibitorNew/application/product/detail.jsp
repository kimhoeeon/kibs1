                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion hover show">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link active" href="/mng/exhibitorNew/application/product.do">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">요트/보트 출품 정보</span>
                                ...
                                <form id="productForm" name="productForm" method="post" onsubmit="return false;">
                                    ...
                                    <div class="card mb-5 mb-xl-10">
                                        ...
                                        <div class="card-header border-0">
                                            <!--begin::Card title-->
                                            <div class="card-title m-0">
                                                <h3 class="fw-bold m-0">요트/보트 출품 정보</h3>
                                            </div>
                                            <!--end::Card title-->
                                        </div>
                                        <!--begin::Card header-->
                                                        ...
                                                        <div class="product_info_box">
                                                            ...
                                                            <div class="row mb-6">
                                                                <h4 class="p-3" style="background:#14214D; color: #FFFFFF;">
                                                                    <input type="hidden" name="productItemSeq" value="${product.seq}">
                                                                    제품 #<span class="productInfoNum">${status.index + 1}</span>
                                                                ...
                                                                <div class="col-lg-10">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-6 col-form-label text-primary">
                                                                            <input type="text" name="productOptionBig" class="form-control form-control-lg form-control-solid-bg" value="${product.productOptionBig}" placeholder="제품분류(대)" disabled/>
                                                                        </div>
                                                                        <!--end::Col-->
                                                                        <!--begin::Col-->
                                                                        <div class="col-lg-6 col-form-label text-primary">
                                                                            <input type="text" name="productOptionSmall" class="form-control form-control-lg form-control-solid-bg" value="${product.productOptionSmall}" placeholder="제품분류(소)" disabled/>
                                                                        </div>
                                                                        <!--end::Col-->
                                                                    </div>
                                                                    <!--end::Row-->
                                                            ...
                                                            <div class="row mb-6">
                                                                ...
                                                                <!--begin::Col-->
                                                                <div class="col-lg-10">
                                                                    <input type="text" name="productLength" class="form-control form-control-lg form-control-solid-bg onlyNumDec" value="${product.productLength}" placeholder="길이(cm)" readonly/>
                                                                </div>
                                                                <!--end::Col-->
                                                            </div>
                                                            <!--end::Input group-->
                                                            ...
                                                            <div class="row mb-6">
                                                                ...
                                                                <!--begin::Col-->
                                                                <div class="col-lg-10">
                                                                    <input type="text" name="productWidth" class="form-control form-control-lg form-control-solid-bg onlyNumDec" value="${product.productWidth}" placeholder="너비(cm)" readonly/>
                                                                </div>
                                                                <!--end::Col-->
                                                            </div>
                                                            <!--end::Input group-->
                                                            ...
                                                            <div class="row mb-6">
                                                                ...
                                                                <!--begin::Col-->
                                                                <div class="col-lg-10">
                                                                    <input type="text" name="productHeight" class="form-control form-control-lg form-control-solid-bg onlyNumDec" value="${product.productHeight}" placeholder="높이(cm)" readonly/>
                                                                </div>
                                                                <!--end::Col-->
                                                            </div>
                                                            <!--end::Input group-->
                                                            ...
                                                            <div class="row mb-6">
                                                                ...
                                                                <!--begin::Col-->
                                                                <div class="col-lg-10">
                                                                    <input type="text" name="productWeight" class="form-control form-control-lg form-control-solid-bg onlyNumDec" value="${product.productWeight}" placeholder="중량(kg)" readonly/>
                                                                </div>
                                                                <!--end::Col-->
                                                            </div>
                                                            <!--end::Input group-->
                                                            ...
                                                            <div class="row mb-6">
                                                                ...
                                                                <!--begin::Col-->
                                                                <div class="col-lg-10">
                                                                    <input type="text" name="productMaterial" class="form-control form-control-lg form-control-solid-bg onlyNumDec" value="${product.productMaterial}" placeholder="소재" readonly/>
                                                                </div>
                                                                <!--end::Col-->
                                                            </div>
                                                            <!--end::Input group-->
                                                            ...
                                                            <div class="row mb-6">
                                                                ...
                                                                <!--begin::Col-->
                                                                <div class="col-lg-10">
                                                                    <input type="text" name="productYear" class="form-control form-control-lg form-control-solid-bg onlyNumDec" value="${product.productYear}" placeholder="연식" readonly/>
                                                                </div>
                                                                <!--end::Col-->
                                                            </div>
                                                            <!--end::Input group-->
                                    ...
                                    <div class="card mb-5 mb-xl-10">
                                        ...
                                        <div class="card-footer d-flex justify-content-between py-6 px-9">
                                            <div>
                                                <a href="/mng/exhibitorNew/application/product.do" class="btn btn-info btn-active-light-info cursor-pointer">목록</a>
                                            </div>
                                            <div>
