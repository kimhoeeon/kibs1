...
<c:if test="${sessionScope.get('status') eq 'logon'}">
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion hover show">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link active" href="/mng/exhibitorNew/application/pass.do">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">출입증 신청</span>
                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">출입증 신청</li>
                                        <!--end::Item-->
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                ...
                                <!--begin::Form-->
                                <form id="passForm" name="passForm" method="post" onsubmit="return false;">
                                    <!--begin::Basic info-->
                                    <div class="card mb-5 mb-xl-10">
                                        ...
                                        <div id="kt_company_info">
                                            ...
                                            <div class="card-body border-top p-9">
                                                <h4 class="fw-bold">${passList.get(0).companyNameKo} / ${passList.get(0).companyNameEn}</h4>
                                            </div>
                                            <!--end::Card body-->
                                        </div>
                                        <!--end::Content-->
                                    ...
                                    <div class="card mb-5 mb-xl-10">
                                        ...
                                        <div class="card-header border-0">
                                            <!--begin::Card title-->
                                            <div class="card-title m-0">
                                                <h3 class="fw-bold m-0">출입증 신청 정보</h3>
                                            </div>
                                            <!--end::Card title-->
                                        </div>
                                        <!--begin::Card header-->
                                        ...
                                        <div id="kt_pass_info">
                                            ...
                                            <div class="card-body border-top p-9">
                                                    ...
                                                    <table class="table table-bordered table-row-gray-400 table-rounded table-row-bordered border gy-7 gs-7">
                                                        ...
                                                        <thead class="bg-primary fw-semibold fs-6 text-white border-bottom-2 border-gray-200">
                                                            <tr class="text-center">
                                                                <th class="ps-3 w-70px">번호</th>
                                                                <th class="w-250px">성명 (국문)</th>
                                                                <th class="w-275px">성명 (영문)</th>
                                                                <th class="w-250px">직책 (국문)</th>
                                                                <th class="w-250px">직책 (영문)</th>
                                                                <th>비고</th>
                                                                <th class="pe-3 w-80px">삭제</th>
                                                            </tr>
                                                        </thead>
                                                        <!--end::Table head-->
                                                        <!--begin::Table body-->
                                                        <tbody>
                                                            <c:if test="${not empty passList}">
                                                                <c:forEach var="pass" items="${passList}" begin="0" end="${passList.size()}" step="1" varStatus="status">
                                                                    <tr class="formTbBd text-center align-middle">
                                                                        <input type="hidden" name="passSeq" value="${pass.id}">
                                                                        <td class="ps-3 addNum">${status.index + 1}</td>
                                                                        <td><input type="text" name="passName" class="form-control form-control-lg form-control-solid-bg" value="${pass.passName}" placeholder="성명(국문)"></td>
                                                                        <td class="d-flex">
                                                                            <input type="text" name="passFirstName" class="form-control form-control-lg form-control-solid-bg" value="${pass.passFirstName}" placeholder="이름(영문)">
                                                                            <input type="text" name="passLastName" class="form-control form-control-lg form-control-solid-bg" value="${pass.passLastName}" placeholder="성(영문)">
                                                                        </td>
                                                                        <td><input type="text" name="passPositionKo" class="form-control form-control-lg form-control-solid-bg" value="${pass.passPositionKo}" placeholder="직책(국문)"></td>
                                                                        <td><input type="text" name="passPositionEn" class="form-control form-control-lg form-control-solid-bg" value="${pass.passPositionEn}" placeholder="직책(영문)"></td>
                                                                        <td><input type="text" name="passNote" class="form-control form-control-lg form-control-solid-bg" value="${pass.passNote}" placeholder="비고"></td>
                                                                        <td class="pe-3 addDel" style="cursor: pointer;"><img src="/img/icon_del.png"></td>
                                                                    </tr>
                                                                </c:forEach>
                                                            </c:if>
                                                        </tbody>
                                                ...
                                                <div class="d-flex align-items-center justify-content-end">
                                                    <div class="btn btn-primary form_add_btn">추가</div>
                                                </div>
                                                <!--begin::end button-->
                                            </div>
                                            <!--end::Card body-->
                                    ...
                                    <div class="card mb-5 mb-xl-10">
                                        ...
                                        <div class="card-footer d-flex justify-content-between py-6 px-9">
                                            <div>
                                                <a href="/mng/exhibitorNew/application/pass.do" class="btn btn-info btn-active-light-info cursor-pointer">목록</a>
                                            </div>
                                            <div>
                                                <button type="button" onclick="f_application_pass_new_modify_init_set('${exSeq}')" class="btn btn-danger btn-active-light-danger me-2">변경내용취소</button>
                                                <button type="button" onclick="f_application_pass_new_save('${exSeq}')" class="btn btn-primary btn-active-light-primary">변경내용저장</button>
                                            </div>
                                        </div>
                                        <!--end::Actions-->
                                    </div>
    ...
    <script src="/js/custom/pass_new.js?ver=<%=System.currentTimeMillis()%>"></script>
    <!--end::Custom Javascript-->
