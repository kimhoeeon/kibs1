...
<c:if test="${sessionScope.get('status') eq 'logon'}">
                                    ...
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown p-0">
                                        ...
                                        <div class="menu-active-bg px-4 px-lg-0">
                                            ...
                                            <div class="tab-content py-4 py-lg-8 px-lg-7">
                                                ...
                                                <!--end:Tab pane-->
                                                <!--begin:Tab pane-->
                                                <div class="tab-pane w-lg-350px active" id="kt_app_header_menu_pages_application_new">
                                                    <!--begin:Row-->
                                                    <div class="row">
                                                        <!--begin:Col-->
                                                        <div class="col-lg-12 mb-6 mb-lg-0">
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion hover show">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link active" href="/mng/exhibitorNew/application/utility.do">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">유틸리티 신청</span>
    ...
    <script src="/js/custom/utility_new.js?ver=<%=System.currentTimeMillis()%>"></script>
    <!--end::Custom Javascript-->
