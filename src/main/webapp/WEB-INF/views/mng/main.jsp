                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 mb-3">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="javascript:alert('현재 사용 중지된 메뉴입니다.');<%--/mng/main.do--%>" class="menu-link">
                            ...
                            <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                ...
                                <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown p-0">
                                    ...
                                    <div class="menu-active-bg px-4 px-lg-0">
                                        ...
                                        <div class="d-flex w-100 overflow-auto">
                                            <ul class="nav nav-stretch nav-line-tabs fw-bold fs-6 p-0 p-lg-10 flex-nowrap flex-grow-1">
                                                ...
                                                <li class="nav-item mx-lg-1">
                                                    <a class="nav-link py-3 py-lg-6 text-active-primary" href="#"
                                                       data-bs-toggle="tab"
                                                       data-bs-target="#kt_app_header_menu_pages_document">나의 서류함</a>
                                                </li>
                                                <!--end:Nav item-->--%>
                                                <!--begin:Nav item-->
                                                <li class="nav-item mx-lg-1">
                                        ...
                                        <div class="tab-content py-4 py-lg-8 px-lg-7">
                                            <!--begin:Tab pane-->
                                            <div class="tab-pane active w-lg-400px" id="kt_app_header_menu_pages_notice">
                                                <!--begin:Row-->
                                                <div class="row">
                                                    <!--begin:Col-->
                                                    <div class="col-lg-12 mb-6 mb-lg-0">
                                            ...
                                            <!--end:Tab pane-->
                                            <!--begin:Tab pane-->
                                            <div class="tab-pane w-lg-400px" id="kt_app_header_menu_pages_newsletter">
                                                <!--begin:Row-->
                                                <div class="row">
                                                    <!--begin:Col-->
                                                    <div class="col-lg-12 mb-6 mb-lg-0">
                        ...
                        <div class="app-navbar-item align-items-stretch ms-md-3">
                            ...
                            <div class="d-flex align-items-stretch">
                                ...
                                <div class="d-flex align-items-center" id="kt_header_admin_menu">
                                    <a href="/mng/admin/detail.do" class="btn btn-dark btn-active-light-dark">접근IP 관리</a>
                                </div>
                                <!--end::admin mng-->
                            </div>
                            <!--end::admin-->
        ...
        <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
            ...
            <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true"
                ...
                <div class="app-sidebar-logo px-6 justify-content-center h-90px" id="kt_app_sidebar_logo">
                    <!--begin::Logo image-->
                    <a href="/mng/main.do">
                        <img alt="Logo" src="/img/logo2_w.png<%--/static/assets/media/logos/default-dark.svg--%>"
                             class="h-65px app-sidebar-logo-default"/>
                        <img alt="Logo" src="/img/logo2_w.png<%--assets/media/logos/default-small.svg--%>"
                                ...
                                <div class="col-lg-12 col-xxl-12 mb-xl-8">
                                    ...
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body p-9">
                                            ...
                                            <div class="mt-5 mb-2">※ 현황 통계는 <span class="text-primary fw-bold">'2025'년 데이터</span>만 나타냅니다.</div>
