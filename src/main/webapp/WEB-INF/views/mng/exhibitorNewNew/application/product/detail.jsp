...
<c:if test="${sessionScope.get('status') eq 'logon'}">
                                ...
                                <form id="productForm" name="productForm" method="post" onsubmit="return false;">
                                    ...
                                    <div class="card mb-5 mb-xl-10">
                                        ...
                                        <div class="card-footer d-flex justify-content-between py-6 px-9">
                                            <div>
                                                <a href="/mng/exhibitorNewNew/application/product.do" class="btn btn-info btn-active-light-info cursor-pointer">목록</a>
                                            </div>
                                            <div>
    ...
    <script src="/js/custom/product_new_new.js?ver=20260630"></script>
