...
<c:if test="${sessionScope.get('status') eq 'logon'}">
                        ...
                        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <!--begin::Export dropdown-->
                                    <%--<button type="button" onclick="f_excel_export('kt_exhibitor_new_new_table', '전시업체')" class="btn btn-dark btn-active-light-dark" data-kt-export="excel" data-kt-menu-placement="bottom-end">
                                        <i class="ki-duotone ki-exit-down fs-2">
                                            <span class="path1"></span>
                                            <span class="path2"></span>
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                ...
                                <div class="card card-flush">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <!--begin::Table-->
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_exhibitor_new_new_table">
                                            <thead>
                                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                    <th class="w-10px pe-2">
                                                        <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                                            <input class="form-check-input" type="checkbox" data-kt-check="true"
                                                                   data-kt-check-target="#kt_exhibitor_new_new_table .form-check-input" value="1"/>
                                                        </div>
                                                    </th>
    ...
    <script src="/js/custom/exhibitorNewNew.js?ver=<%=System.currentTimeMillis()%>"></script>
