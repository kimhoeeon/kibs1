...
<c:if test="${sessionScope.get('status') eq 'logon'}">
                                ...
                                <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                    ...
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown p-0">
                                        ...
                                        <div class="menu-active-bg px-4 px-lg-0">
                                            ...
                                            <!--end:Tabs nav-->
                                            <!--begin:Tab content-->
                                            <div class="tab-content active py-4 py-lg-8 px-lg-7">
                                                <!--begin:Tab pane-->
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion hover show">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link active" href="/mng/event/company.do">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                                <span class="menu-title">참가자 목록</span>
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">KIBS 참가업체</li>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item">
                                            <span class="bullet bg-gray-400 w-5px h-2px"></span>
                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <button type="button" onclick="f_excel_export('kt_event_company_table', '참가업체')" class="btn btn-success btn-active-light-success" data-kt-export="excel" data-kt-menu-placement="bottom-end">
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                ...
                                <div class="card card-flush">
                                    ...
                                    <div class="card-header align-items-center py-5 gap-2">
                                        ...
                                        <div class="card-title w-100">
                                            ...
                                            <div class="w-100 mw-150px">
                                                ...
                                                <select id="search_box" class="form-select form-select-solid" data-control="select2"
                                                    ...
                                                    <option value="companyName" selected>업체명(국문)</option>
                                                </select>
                                                <!--end::Select2-->
                                            </div>
                                            <%--end::검색구분--%>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <button type="button" onclick="f_event_company_search()" class="btn btn-primary me-5">Search</button>
                                                <button type="button" onclick="f_event_company_search_condition_init()" class="btn btn-secondary me-5">
                                        ...
                                        <div class="card-toolbar flex-row-fluid gap-5">
                                            ...
                                            <div class="w-100 mw-200px">
                                                <!--begin::Select2-->
                                                <select id="kibsYear" class="form-select form-select-solid" data-control="select2"
                                                        data-hide-search="true" data-allow-clear="true"
                                                        data-placeholder="- 수상연도 -" onchange="f_search_condition_sel_change()">
                                                    <option></option>
                                            ...
                                            <!--begin::참가자 등록-->
                                            <a onclick="f_event_company_modify_init_set('')" class="btn btn-primary ms-auto cursor-pointer">참가자 등록</a>
                                            <!--end::참가자 등록-->
                                        </div>
                                        <!--end::Card toolbar-->
                                    </div>
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <!--begin::Table-->
                                        <table class="table align-middle table-row-dashed fs-6 gy-5 table-layout-fixed" id="kt_event_company_table">
                                            <thead>
                                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                    <th class="text-center min-w-40px" style="max-width: 50px;">번호</th>
                                                    <th>seq</th>
                                                    <th class="text-center min-w-75px" style="max-width: 75px;">KIBS Year</th>
                                                    <th class="text-center min-w-100px" style="max-width: 125px;">Homepage</th>
                                                    <th class="text-center min-w-100px" style="max-width: 125px;">Exhibit Categories</th>
                                                    <th class="text-center min-w-100px" style="max-width: 125px;">회사명</th>
                                                    <th class="text-center min-w-75px" style="max-width: 75px;">담당자 이름</th>
                                                    <th class="text-center min-w-100px" style="max-width: 125px;">휴대전화 / 이메일</th>
                                                    <th class="text-center min-w-100px" style="max-width: 125px;">등록일시</th>
                                                    <th class="text-center min-w-100px" style="max-width: 125px;">수정일시</th>
                                                    <th class="text-center min-w-75px" style="max-width: 75px;">기능</th>
                                                </tr>
                                            </thead>
    ...
    <script src="/js/custom/eventCompany.js?ver=<%=System.currentTimeMillis()%>"></script>
