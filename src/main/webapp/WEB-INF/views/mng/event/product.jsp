                                ...
                                <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                    ...
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown p-0">
                                        ...
                                        <div class="menu-active-bg px-4 px-lg-0">
                                            ...
                                            <div class="tab-content py-4 py-lg-8 px-lg-7">
                                                <!--begin:Tab pane-->
                                                <div class="tab-pane active w-lg-250px" id="kt_app_header_menu_pages_product">
                                                    <!--begin:Row-->
                                                    <div class="row">
                                                        <!--begin:Col-->
                                                        <div class="col-lg-12 mb-6 mb-lg-0">
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion hover show">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link active" href="/mng/event/product.do">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                                <span class="menu-title">참가자 목록</span>
                        ...
                        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <button type="button" onclick="f_excel_export('kt_event_product_table', '올해의제품')" class="btn btn-success btn-active-light-success" data-kt-export="excel" data-kt-menu-placement="bottom-end">
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                ...
                                <div class="card card-flush">
                                    ...
                                    <div class="card-header align-items-center py-5 gap-2">
                                        ...
                                        <div class="card-title w-100">
                                            ...
                                            <div class="w-100 mw-150px">
                                                ...
                                                <select id="search_box" class="form-select form-select-solid" data-control="select2"
                                                    ...
                                                    <option value="companyNameKo" selected>업체명(국문)</option>
                                                    <option value="companyNameEn">업체명(영문)</option>
                                                </select>
                                                <!--end::Select2-->
                                            </div>
                                            <%--end::검색구분--%>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <button type="button" onclick="f_event_product_search()" class="btn btn-primary me-5">Search</button>
                                                <button type="button" onclick="f_event_product_search_condition_init()" class="btn btn-secondary me-5">
                                        ...
                                        <div class="card-toolbar flex-row-fluid gap-5">
                                            ...
                                            <div class="w-100 mw-200px">
                                                <!--begin::Select2-->
                                                <select id="awardYear" class="form-select form-select-solid" data-control="select2"
                                                        data-hide-search="true" data-allow-clear="true"
                                            ...
                                            <div class="w-100 mw-200px">
                                                <!--begin::Select2-->
                                                <select id="gbn" class="form-select form-select-solid" data-control="select2"
                                                        data-hide-search="true" data-allow-clear="true"
                                                        data-placeholder="- 분류 -" onchange="f_search_condition_sel_change()">
                                                    <option></option>
                                                    <option disabled>- 분류 -</option>
                                                    <option value="END_PRD">완성품</option>
                                                    <option value="PART_PRD">부품</option>
                                                    <option value="ABR_BOAT">해외 요트/보트</option>
                                                    <option value="SKILL_BU">기술 [부품]</option>
                                                    <option value="IMPRV_BU">개선도 [부품]</option>
                                                    <option value="IMPRV_END">개선도 [완제품]</option>
                                                    <option value="MARK_END">시장성 [완제품]</option>
                                                    <option value="IDEA_END">아이디어 [완제품]</option>
                                                    <option value="INVATE">인비테이션어워드</option>
                                                </select>
                                                <!--end::Select2-->
                                            </div>
                                            <%--end::분류--%>
                                            ...
                                            <!--begin::참가자 등록-->
                                            <a onclick="f_event_product_modify_init_set('')" class="btn btn-primary ms-auto cursor-pointer">참가자 등록</a>
                                            <!--end::참가자 등록-->
                                        </div>
                                        <!--end::Card toolbar-->
                                    </div>
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <!--begin::Table-->
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_event_product_table">
                                            <thead>
                                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                    <th class="text-center min-w-50px">번호</th>
                                                    <th>seq</th>
                                                    <th class="text-center min-w-75px">수상연도</th>
                                                    <th class="text-center min-w-100px">분류</th>
                                                    <th class="text-center min-w-150px">업체명</th>
                                                    <th class="text-center min-w-150px">제품명</th>
                                                    <th class="text-center min-w-150px">홈페이지</th>
