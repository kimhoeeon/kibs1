                                ...
                                <form id="companyForm" name="companyForm" method="post" onsubmit="return false;">
                                                ...
                                                <div class="row mb-8">
                                                    ...
                                                    <div class="col-lg-10">
                                                        ...
                                                        <select id="kibsYear" name="kibsYear" class="form-select form-select-solid" data-control="select2"
                                                            ...
                                                            <option></option>
                                                            <option value="" disabled>- KIBS Year -</option>
                                                            <option value="2023" <c:if test="${info.kibsYear eq '2023'}"> selected </c:if> >2023</option>
                                                            <option value="2022" <c:if test="${info.kibsYear eq '2022'}"> selected </c:if> >2022</option>
                                                            <option value="2021" <c:if test="${info.kibsYear eq '2021'}"> selected </c:if> >2021</option>
                                                            <option value="2020" <c:if test="${info.kibsYear eq '2020'}"> selected </c:if> >2020</option>
                                                            <option value="2019" <c:if test="${info.kibsYear eq '2019'}"> selected </c:if> >2019</option>
                                                            <option value="2018" <c:if test="${info.kibsYear eq '2018'}"> selected </c:if> >2018</option>
                                                            <option value="2017" <c:if test="${info.kibsYear eq '2017'}"> selected </c:if> >2017</option>
                                                        </select>
                                                        <!--end::Select2-->
                                                    </div>
                                                    <!--end::Col-->
                                    ...
                                    <div class="card mb-5 mb-xl-10">
                                        ...
                                        <div class="card-footer d-flex justify-content-between py-6 px-9">
                                            <div>
                                                <a href="/mng/event/company.do" class="btn btn-info btn-active-light-info">목록</a>
                                            </div>
                                            <div>
                                                <button type="button" onclick="f_event_company_modify_init_set('${info.seq}')" class="btn btn-danger btn-active-light-danger me-2">변경내용취소</button>
                                                <button type="button" onclick="f_event_company_save('${info.seq}')" class="btn btn-primary btn-active-light-primary">변경내용저장</button>
                                            </div>
                                        </div>
                                        <!--end::Actions-->
                                    </div>
