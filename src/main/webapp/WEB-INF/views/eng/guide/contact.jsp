        ...
        <div class="inner">
            <div class="sub_top_box">
                <div class="sub_top_nav">
                    <span>Home</span><span>KIBS 2025</span><span>Contact us</span>
                </div>
            ...
            <div class="contact_box">
                ...
                <ul class="txt_box">
                    <li>
                        ...
                        <div class="cont">+82 1670 8785</div>
                    </li>
                    <li>
                        <div class="gubun">Fax</div>
                        <div class="cont">+82 31 995 8082</div>
                    </li>
                    <li>
                        <div class="gubun">E-mail</div>
                        <div class="cont">kibs@kintex.com</div>
                    </li>
                    <li>
                        <div class="gubun">Address</div>
                        <div class="cont">KINTEX, 217-60 Kintex-ro, Ilsanseo-gu, Goyang, Gyeonggi Province, 10390 Republic of Korea</div>
                    </li>
                </ul>
            </div>
        </div>
