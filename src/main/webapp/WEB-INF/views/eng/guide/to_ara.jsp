...
<div id="container">
    ...
    <div class="ssub_tab padding_t">
        <div class="inner">
            <ul class="ssub_tab_box">
                ...
                <%--<li class="active"><a href="/eng/guide/to_ara.do">To ARA Marina</a></li>--%>
            </ul>
        </div>
    </div>
    <!-- //section -->
    ...
    <div class="venue_s venue_s1 padding_b">
        <div class="inner">
            <div class="venue_box">
                <div class="map_box">
                    <div class="map_img"><img src="/img/img_ara_map.jpg"></div>
                    <div class="map_cont">
                        <div class="tit">To ARA Marina</div>
                        <div class="txt">
                            <p>Located in Gimpo, Ara Marina Convention is a picturesque waterfront meeting facility by theGyeonginAra Waterway, offering great views of the Han River. <p>
                            <p>Ara Marina is just 40 minutes away from Incheon International Airport and about 15 minutes away from Gimpo International Airport near major highways, ensuring quick and easy access to Seoul.<p>
                        </div>
                    </div>
                </div>
                <div class="photo_box">
                    <img src="/img/img_exhi_ara_01.jpg">
                    <img src="/img/img_exhi_ara_02.jpg">
                    <img src="/img/img_exhi_ara_03.jpg">
                </div>
            </div>
        </div>
    </div>
