...
<div id="container">
    ...
    <!-- section -->
    <div class="summ_s2 padding_tb" style="background-color: #fff;">
        <div class="inner">
            <div class="summ_venue">
                <div class="img_box"><img src="/img/img_venue_01_eng.png"></div>
                <div class="txt_box">
                    <div class="tit"><img src="/img/img_venue_kintex.png"><span class="blue">1F</span></div>
                    <div class="btn">
                        <a href="https://www.kintex.com/web/en/html/service/parking_transportation.do" target="_blank">Transportation</a>
                        <a href="https://www.kintex.com/web/en/html/service/tourist_attraction.do"
                           target="_blank">Tourism Information</a>
                        <%--<a href="https://www.kintex.com/web/en/service/etcHotel.do" target="_blank">Accommodation</a>--%>
                    </div>
                    <div class="table_box">
                        <table>
                            <colgroup>
                            ...
                            <tr>
                                <td>ADRESS</td>
                                <td>KINTEX, 217-60 Kintex-ro, Ilsanseo-gu, Goyang, Gyeonggi Province, 10390 Republic of Korea</td>
                            </tr>
                            <tr>
                                <td>TEL</td>
