        ...
        <div class="inner">
                    ...
                    <ul class="list1">
                        ...
                        <li class="active">
                            ...
                            <ul class="list2">
                                ...
                                <li class="active"><a href="/eng/apply/step2_8.do">Directory</a></li>
                            </ul>
                        </li>
            ...
            <div class="apply_step">
                ...
                <div class="apply_step_wrap">
                    ...
                    <div class="apply_step_box step2">
                        ...
                        <div class="txt">Proceeding...(6/7)</div>
                    </div>
            ...
            <div class="apply_form form_s padding_t">
                <div class="inner">
                    ...
                    <div class="form_btn">
                        <a href="/eng/apply/step2_6.do#apply_s" class="form_btn_prev">
                            <div class="big">PREV</div>
                            <div class="small">Web Banner</div>
                        </a>
                        <a href="/eng/apply/step03.do#apply_s" class="form_btn_next">
