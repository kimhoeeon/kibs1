            ...
            <div class="apply_nav">
                <div class="apply_nav_list">
                    <ul class="list1">
                        ...
                        <li class="active"><a href="/eng/apply/step03.do">Complete Registration</a></li>
                    </ul>
                </div>
            </div>

            <div class="apply_step">
                <div class="apply_tit">Complete Registration</div>
                    ...
                    <div class="form_wrap">
                        <div class="form_guide_comp">
                            ...
                            <div class="form_guide_comp_txt">
                                You have entered all the required documents to participate in the 2025 Gyeonggi
