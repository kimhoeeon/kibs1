...
<c:choose>
    <c:when test="${mode eq 'soon'}">
        <script>
            alert('Applications for participating companies in the 2027 Korea International Boat Show are being prepared.');
            window.location.href = '/eng/guide/summary.do';
        </script>
    </c:when>
    <c:when test="${mode eq 'close'}">
        <script>
            alert('Applications for participating companies at the 2027 Korea International Boat Show have closed.');
            window.location.href = '/eng/guide/summary.do';
        </script>
    </c:when>
    <c:otherwise>
    ...
    <c:if test="${sessionScope.get('status') eq 'logon'}">
        <script>
            alert("I am logged in with the ID I already applied.\nPlease log out and try to register as a new participant.");
    ...
    <c:if test="${sessionScope.get('status') ne 'logon'}">
                ...
                <div class="inner">
                    ...
                    <div class="apply_nav">
                        <div class="apply_nav_list">
                            <ul class="list1">
                                <li class="active">
                                    <a href="javascript:void(0);" onclick="f_page_move('/eng/apply/step01.do','${info.seq}')">Basic Info</a>
                                </li>
                                <li>
                                    <a>Exhibition Info</a>
                                    <ul class="list2">
                    ...
                    <div class="apply_step">
                        ...
                        <div class="apply_step_wrap">
                            <div class="apply_step_box step1">
                                ...
                                <div class="txt">Please enter exhibitor information.</div>
                            </div>
                            <div class="apply_step_box step2">
                                ...
                                <div class="txt">Please complete the previous step first.</div>
                            </div>
                        ...
                        <div class="inner">
                            ...
                            <div class="form_wrap">
                                ...
                                <div class="form_pri">
                                    ...
                                    <div class="form_pri_agree">
                                        <label><input type="radio" name="agree1" value="Y" <c:if test="${not empty info}">checked</c:if> >Agree</label>
                            ...
                            <div class="form_wrap">
                                ...
                                <div class="form_pri">
                                    ...
                                    <div class="form_pri_agree">
                                        <label><input type="radio" name="agree2" value="Y" <c:if test="${not empty info}">checked</c:if> >Agree</label>
                            ...
                            <form id="exhibitor_apply_form" method="post" onsubmit="return false;" enctype="multipart/form-data">
                                ...
                                <div class="form_wrap">
                                    <div class="form_tit">
                                        ...
                                        <div class="small">Required for managing your exhibitor application and additional service requests.</div>
                                    </div>
                                    <ul class="form_box">
                                        <li>
                                            <div class="item req">
                                        ...
                                        <li>
                                            ...
                                            <div class="input">
                                                <input type="password" id="password" name="password" maxlength="16" value="${info.password}" onchange="f_pw_status_change(this)" placeholder="Enter password" class="w50" autocomplete="new-password">
                                                <%--<input type="button" onclick="f_pw_check(this)" style="margin-left: 10px;" value="비밀번호 유효성 검사">--%>
                                                <div class="cmnt">Use 8-16 characters including letters, numbers and special characters.</div>
                                                <c:if test="${not empty info}"><input type="hidden" id="pwCheck" value="true"></c:if>
                                                <c:if test="${empty info}">
                                                    <div class="cmnt" style="color: #AD1D1D;">Please validate your password.</div>
                                        ...
                                        <li>
                                            ...
                                            <div class="input">
                                                <input type="password" id="passwordCheck" maxlength="16" onkeyup="f_pw_confirm_check(this)" placeholder="Confirm Password" class="w50">
                                                <c:if test="${not empty info}"><input type="hidden" id="pwConfirmCheck" value="true"></c:if>
                                                <c:if test="${empty info}">
                                                    <div class="cmnt" style="color: #AD1D1D;">Please enter your password again.</div>
                                ...
                                <div class="form_wrap">
                                    <div class="form_top">
                                        ...
                                        <div class="rbox">
                                            <a href="javascript:void(0);" class="form_info_load" data-pop="popFormInfoLoad">Load Application Info</a>
                                            <a href="javascript:void(0);" onclick="f_pre_exhibitor_info_call_init();" class="form_reset">Reset</a>
                                        </div>
                                    </div>
                                    <ul class="form_box">
                                        <li>
        ...
        <!-- 참가신청 정보 불러오기 -->
        <div class="popup" id="popFormInfoLoad">
            <div class="popup_inner">
                <div class="popup_wrap">
                    <div class="pop_tit">
                        <div class="tit">Participant Certification</div>
                    </div>
                    <div class="pop_box">
                        <div class="pop_info_load">
                            <div class="text">
                                After confirming the email address that can receive the authentication code,<br>
                                Please click the [Send] button on the right.
                            </div>
                            <div class="list">
                                    <%--<div class="item">
                                        <div class="mail">cm*****@m*********</div>
                                        <input type="button" value="발송">
                                    </div>
                                    <div class="item">
                                        <div class="mail">cm*****@m*********</div>
                                        <input type="button" value="발송" disabled>
                                    </div>
                                    <div class="item">
                                        <div class="mail">cm*****@m*********</div>
                                        <input type="button" value="발송" disabled>
                            ...
                            <div id="certifyBox" class="input" style="display: none;">
                                <input type="text" id="certifyNum" class="onlyNum" maxlength="5" placeholder="Please enter your authentication number.">
                                <input type="button" id="certifyBtn" onclick="f_certify_confirm(this);" value="Confirm">
                                <input type="hidden" id="certifyFlag" name="certifyFlag" value="false">
                                <div class="time">Validity Period <span id="remainMin">05</span><span id="colon">:</span><span id="remainSec">00</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="pop_bot">
                        <div class="pop_btn">
                            <a href="javascript:void(0);" id="certifyCloseBtn" onclick="f_certify_close();" class="close btnSt04">Close</a>
                            <a href="javascript:void(0);" class="btnSt02" onclick="f_pre_exhibitor_info_call();">LOAD</a>
                        </div>
                    </div>
                </div>
            </div>
