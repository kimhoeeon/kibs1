...
<div id="container">
    ...
    <div class="tv_tab">
        <div class="inner">
            ...
            <div class="tv_cate">
                <a href="/eng/board/kibstv.do" class="active">by Year</a>
                <a href="/eng/board/kibstv_cate.do">by Category</a>
            </div>
            <ul class="field">
                <li class="active">
                    <a class="cate" data-value="전체보기" onclick="f_kibstv_year_search(this, '전체보기')" style="cursor: pointer">ALL</a>
                </li>
                <li>
                    <a class="cate" data-value="2025" onclick="f_kibstv_year_search(this, '2025')" style="cursor: pointer">2025 KIBS</a>
                </li>
                <li>
                    <a class="cate" data-value="2024" onclick="f_kibstv_year_search(this, '2024')" style="cursor: pointer">2024 KIBS</a>
                </li>
                <li>
                    <a class="cate" data-value="2023" onclick="f_kibstv_year_search(this, '2023')" style="cursor: pointer">2023 KIBS</a>
                </li>
                <li>
                    <a class="cate" data-value="2022" onclick="f_kibstv_year_search(this, '2022')" style="cursor: pointer">2022 KIBS</a>
                </li>
                <li>
                    <a class="cate" data-value="2021" onclick="f_kibstv_year_search(this, '2021')" style="cursor: pointer">2021 KIBS</a>
                </li>
                <li>
                    <a class="cate" data-value="2020" onclick="f_kibstv_year_search(this, '2020')" style="cursor: pointer">2020 KIBS</a>
                </li>
                <li>
                    <a class="cate" data-value="2019" onclick="f_kibstv_year_search(this, '2019')" style="cursor: pointer">2019 KIBS</a>
                </li>
                <li>
                    <a class="cate" data-value="2018" onclick="f_kibstv_year_search(this, '2018')" style="cursor: pointer">2018 KIBS</a>
                </li>
            </ul>
        </div>
    </div>
...
<script src="/js/front/kibstvCate.js?ver=<%=System.currentTimeMillis()%>"></script>
</body>
</html>