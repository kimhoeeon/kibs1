        ...
        <div class="inner">
            <div class="sub_top_box">
                <div class="sub_top_nav">
                    <span>Home</span><span>News</span><span>KIBS in Media</span>
                </div>
                <div class="sub_top_tit">KIBS in Media</div>
            </div>
        </div>
    </div>
    <!-- //section -->
            ...
            <div class="sub_tab_box">
                ...
                <div class="optionBox">
                    ...
                    <div class="tabOpt2 tabOption">
                        <div class="tabOptAct">KIBS in Media</div>
                        <div class="tabOptSel">
                            <a href="/eng/board/notice.do">Notice</a>
                            <a href="/eng/board/kibstv.do">KIBS Tube</a>
                            <%--<a class="active" href="/eng/board/media.do">KIBS in Media</a>--%>
        ...
        <div class="inner">
            <div class="search">
                <form class="search_box">
                        <span class="select">
                            <select>
                                <option value="제목">Subject</option>
                                <option value="내용">Content</option>
                                <option value="내용+제목">Content+Subject</option>
                            </select>
                        </span>
                    <span class="search">
            ...
            <div class="board_list_box">
                ...
                <ul class="tBody">
                    <li class="postNt">
                        ...
                        <div class="tit" onClick="location.href='/eng/board/mediaView.do'">게시판 제목이 노출됩니다.</div>
