                                ...
                                <div class="form_wrap">
                                    ...
                                    <ul class="form_box">
                                        <li>
                                            ...
                                            <div class="input">
                                                <input type="text" id="companyNameKo" name="companyNameKo" value="${info.companyNameKo}" placeholder="Korean" class="w50">
                                                <input type="text" id="companyNameEn" name="companyNameEn" value="${info.companyNameEn}" placeholder="English" class="w50 onlyNumEng">
                                            </div>
                                        </li>
                                        <li>
                                            <div class="item req">
