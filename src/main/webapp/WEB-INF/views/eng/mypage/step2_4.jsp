        ...
        <div class="inner">
                    ...
                    <ul class="list1">
                        ...
                        <li class="active">
                            ...
                            <ul class="list2">
                                ...
                                <li class="active"><a href="/eng/mypage/step2_4.do">Exhibitor Pass</a></li>
            ...
            <div class="my_form form_s">
                <div class="inner">
                    ...
                    <div class="form_btn">
                        <a href="/eng/mypage/step2_3.do#apply_s" class="form_btn_prev">
                            <div class="big">PREV</div>
                            <div class="small">Utilities</div>
                        </a>
                        <a href="/eng/mypage/step2_5.do#apply_s" class="form_btn_next">
