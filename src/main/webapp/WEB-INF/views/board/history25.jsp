...
<div id="container">
    ...
    <div class="history_s history_s1 padding_b">
        <div class="inner">
            ...
            <!-- 전시회개요 -->
            <div class="hist_info">
                <div class="poster"><img src="/img/img_history_2025.jpg"></div>
                <div class="hist_table">
                    <div class="table_box">
                        <table>
                            ...
                            <tr>
                                <td>전시명</td>
                                <td>2025 경기국제보트쇼 (Korea International Boat Show 2025)</td>
                            </tr>
                            <tr>
                                <td>개최일</td>
                                <td>2025. 2. 28(금) ~ 3. 2(일)</td>
                            </tr>
                            <tr>
                                <td>규 모</td>
                                <td>26,487㎡</td>
                            ...
                            <tr>
                                <td>주 관</td>
                                <td>KINTEX, 한국마리나협회, 한국해양레저산업협회</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
