    ...
    <div class="ssub_tab padding_t">
        <div class="inner">
            <ul class="ssub_tab_box">
                <li><a href="/board/press.do">보도자료</a></li>
                <li class="active"><a href="/board/column.do">칼럼</a></li>
            </ul>
        </div>
    </div>
    <!-- //section -->
            ...
            <div class="search">
                <form class="search_box" onsubmit="return false;">
                    ...
                    <span class="search">
                        ...
                        <button type="button" onclick="columnList(1)" style="cursor: pointer"></button>
                    </span>
                </form>
            </div>
        </div>
...
<script src="/js/front/column.js?ver=<%=System.currentTimeMillis()%>"></script>
</body>
</html>