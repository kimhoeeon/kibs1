    ...
    <div class="year_tab padding_t">
        <div class="inner">
            <div class="year_tab_box">
                ...
                <a href="/board/history23.do" class="active">2023</a>
                ...
                <div class="hist_table">
                    <div class="table_box">
                        <table>
                            ...
                            <tr>
                                <td>전시명</td>
                                <td>2023 경기국제보트쇼 (Korea International Boat Show 2023)</td>
                            </tr>
                            <tr>
                                <td>개최일</td>
                                <td>2023. 3. 3(금) ~ 3.5(일)</td>
                            </tr>
                            <tr>
                                <td>규 모</td>
                                <td>26,487㎡</td>
                            ...
                            <tr>
                                <td>장 소</td>
                                <td>KINTEX 3,4,5홀 / 김포 아라마리나 (온라인 전시관 상시운영)</td>
                            </tr>
                            <tr>
                                <td>주 최</td>
                                <td>해양수산부, 경기도</td>
                    ...
                    <div class="btn_box">
                        <a href="/file/2023 보트쇼 쇼가이드북.pdf" target="_blank" class="btnSt01">2023 경기국제보트쇼 한 눈에 보기</a>
                        <a href="/file/2023 보트쇼 쇼가이드북.pdf" download class="btnSt01">2023 경기국제보트쇼 Show Guide
                            다운로드</a>
                    </div>
