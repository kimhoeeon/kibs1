...
<div id="container">
    ...
    <div class="history_s history_s1 padding_b">
        <div class="inner">
            ...
            <!-- 전시회개요 -->
            <div class="hist_info">
                <div class="poster"><img src="/img/img_history_2024.jpg"></div>
                <div class="hist_table">
                    <div class="table_box">
                        <table>
                            ...
                            <tr>
                                <td>전시명</td>
                                <td>2024 경기국제보트쇼 (Korea International Boat Show 2024)</td>
                            </tr>
                            <tr>
                                <td>개최일</td>
                                <td>2024. 3. 8(금) ~ 3.10(일)</td>
                            </tr>
                            <tr>
                                <td>규 모</td>
                                <td>26,487㎡</td>
                            ...
                            <tr>
                                <td>장 소</td>
                                <td>KINTEX 3,4,5홀 (온라인 전시관 상시운영)</td>
                            </tr>
                            <tr>
                                <td>주 최</td>
                                <td>해양수산부, 경기도</td>
                            ...
                            <tr>
                                <td>주 관</td>
                                <td>KINTEX, Kotra, 수자원환경산업진흥, 한국해양레저산업협회, 한국마리나협회</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
                    <div class="btn_box">
                        <a href="/file/2024_boatshow_show_guide_book.pdf" target="_blank" class="btnSt01">2024 경기국제보트쇼 한 눈에 보기</a>
                        <a href="/file/2024_boatshow_show_guide_book.pdf" class="btnSt01" download="2024_경기국제보트쇼_show_guide">2024 경기국제보트쇼 Show Guide 다운로드</a>
                    </div>
