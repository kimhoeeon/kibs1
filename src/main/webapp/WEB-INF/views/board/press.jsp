    ...
    <div class="ssub_tab padding_t">
        <div class="inner">
            <ul class="ssub_tab_box">
                <li class="active"><a href="/board/press.do">보도자료</a></li>
                <li><a href="/board/column.do">칼럼</a></li>
            </ul>
        </div>
    </div>
    <!-- //section -->
            ...
            <div class="search">
                <form class="search_box" onsubmit="return false;">
                    ...
                    <span class="search">
                        ...
                        <button type="button" onclick="pressList(1)" style="cursor: pointer"></button>
                    </span>
                </form>
            </div>
        </div>
...
<script src="/js/front/press.js?ver=<%=System.currentTimeMillis()%>"></script>
</body>
</html>