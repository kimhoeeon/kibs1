...
<div id="container">
    ...
    <div class="year_tab padding_t">
        <div class="inner">
            <div class="year_tab_box">
                ...
                <a href="/board/history16.do" class="active">2016</a>
    ...
    <div class="history_s history_s1">
        <div class="inner">
            ...
            <!-- 전시회개요 -->
            <div class="hist_info">
                <div class="poster"><img src="/img/img_history_2016.png"></div>
                <div class="hist_table">
                    <div class="table_box">
                        <table>
                            ...
                            <tr>
                                <td>전시명</td>
                                <td>2016 경기국제보트쇼 (Korea International Boat Show 2016)</td>
                            </tr>
                            <tr>
                                <td>개최일</td>
                                <td>2016.5.19(목) ~ 5.22(일)</td>
                            </tr>
                            <tr>
                                <td>규 모</td>
                                <td>전체 57,557㎡(실내 32,157㎡ / 해상 25,400㎡)</td>
                            </tr>
                            <tr>
                                <td>장 소</td>
                ...
                <ul>
                    <li>
                        ...
                        <div class="txt_box">
                            ...
                            <div class="txt"><span class="big">27</span><span class="small">개 업체</span></div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="txt_box">
                            ...
                            <div class="txt"><span class="big">253</span><span class="small">개 업체</span></div>
                        </div>
                    </li>
                </ul>
            </div>
