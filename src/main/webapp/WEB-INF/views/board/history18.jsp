...
<div id="container">
    ...
    <div class="year_tab padding_t">
        <div class="inner">
            <div class="year_tab_box">
                ...
                <a href="/board/history18.do" class="active">2018</a>
    ...
    <div class="history_s history_s1">
        <div class="inner">
            ...
            <!-- 전시회개요 -->
            <div class="hist_info">
                <div class="poster"><img src="/img/img_history_2018.png"></div>
                <div class="hist_table">
                    <div class="table_box">
                        <table>
                            ...
                            <tr>
                                <td>전시명</td>
                                <td>2018 경기국제보트쇼 (Korea International Boat Show 2018)</td>
                            </tr>
                            <tr>
                                <td>개최일</td>
                                <td>2018.5.24(목) ~ 5.27(일)</td>
                            </tr>
                            <tr>
                                <td>규 모</td>
                                <td>전체 60,400㎡(실내 35,000㎡ / 해상 25,400㎡)</td>
                            </tr>
                            <tr>
                                <td>장 소</td>
                                <td>KINTEX 3, 4, 5홀 / 아라마리나</td>
                            </tr>
                            <tr>
                                <td>주 최</td>
                                <td>해양수산부, 경기도</td>
                            ...
                            <tr>
                                <td>주 관</td>
                                <td>KINTEX, KOTRA, Waterway+, (특)한국마리나협회</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
                    <div class="btn_box">
                        <a href="/file/2018 KIBS Show Guide.pdf" target="_blank" class="btnSt01">2018 경기국제보트쇼 한 눈에 보기</a>
                        <a href="/file/2018 KIBS Show Guide.pdf" download class="btnSt01">2018 경기국제보트쇼 Show Guide
                            다운로드</a>
                    </div>
    ...
    <!-- section -->
    <div class="history_s history_s2 padding_b">
        <div class="inner">
            <div class="sub_cont_tit">
                ...
                <ul>
                    <li>
                        ...
                        <div class="txt_box">
                            ...
                            <div class="txt"><span class="big">20</span><span class="small">개 업체</span></div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="txt_box">
                            ...
                            <div class="txt"><span class="big">371</span><span class="small">개 업체</span></div>
                        </div>
                    </li>
                </ul>
            </div>
