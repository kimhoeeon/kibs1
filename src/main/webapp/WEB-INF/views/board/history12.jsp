...
<div id="container">
    ...
    <div class="year_tab padding_t">
        <div class="inner">
            <div class="year_tab_box">
                ...
                <a href="/board/history12.do" class="active">2012</a>
    ...
    <div class="history_s history_s1">
        <div class="inner">
            ...
            <!-- 전시회개요 -->
            <div class="hist_info">
                <div class="poster"><img src="/img/img_history_2012.jpg"></div>
                <div class="hist_table">
                    <div class="table_box">
                        <table>
                            ...
                            <tr>
                                <td>전시명</td>
                                <td>2012 경기국제보트쇼 (Korea International Boat Show 2012)</td>
                            </tr>
                            <tr>
                                <td>개최일</td>
                                <td>2012.5.30(수) ~ 6.3(일)</td>
                            </tr>
                            <tr>
                                <td>규 모</td>
                                <td>관람객 : 170,000명 / 참가업체 340개 업체 (국내 99, 국외 241)</td>
                            </tr>
                            <tr>
                                <td>장 소</td>
                ...
                <ul>
                    <li>
                        ...
                        <div class="txt_box">
                            ...
                            <div class="txt"><span class="big">32</span><span class="small">개국</span></div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="txt_box">
                            ...
                            <div class="txt"><span class="big">190</span><span class="small">개 업체</span></div>
                            <div class="cmnt">(국내 99+국외 91)</div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="txt_box">
                            ...
                            <div class="txt"><span class="big">150</span><span class="small">개 업체</span></div>
                        </div>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="swiper swiper_histPhoto">
                        <ul class="swiper-wrapper">
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2012_1b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2012_2b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2012_3b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2012_4b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2012_5b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2012_6b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2012_7b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2012_8b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2012_9b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2012_10b.jpg">
                                </div>
                            </li>
                        </ul>
                    </div>
