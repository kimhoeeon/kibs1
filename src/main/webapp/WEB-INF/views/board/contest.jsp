        ...
        <div class="inner">
            <div class="sub_top_box">
                <div class="sub_top_nav">
                    <span>홈</span><span>미디어센터</span><span>해양레저 사진 공모전</span>
                </div>
                <div class="sub_top_tit">해양레저 사진 공모전</div>
            </div>
        </div>
    </div>
    <!-- //section -->
            ...
            <div class="sub_tab_box">
                ...
                <div class="optionBox">
                    ...
                    <div class="tabOpt2 tabOption">
                        <div class="tabOptAct">해양레저 사진 공모전</div>
                        <div class="tabOptSel">
                            ...
                            <a class="active" href="/board/contest.do">해양레저 사진 공모전</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="year_tab padding_t">
        <div class="inner">
            <div class="year_tab_box">
                ...
                <%--<a class="cate" data-value="4" onclick="f_contest_category_search(this, '4')" style="cursor: pointer">제4회</a>--%>
            ...
            <div class="search">
                <form class="search_box" onsubmit="return false;">
                    ...
                    <span class="search">
                        ...
                        <button type="button" onclick="contestList(1, '전체')" style="cursor: pointer"></button>
                    </span>
                </form>
            </div>
        </div>
...
<script src="/js/front/contest.js?ver=<%=System.currentTimeMillis()%>"></script>
</body>
</html>