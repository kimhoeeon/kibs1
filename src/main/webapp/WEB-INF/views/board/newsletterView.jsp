        ...
        <div class="inner">
            <div class="sub_top_box">
                <div class="sub_top_nav">
                    <span>홈</span><span>미디어센터</span><span>뉴스레터</span>
                </div>
                <div class="sub_top_tit">뉴스레터</div>
            </div>
        </div>
    </div>
    <!-- //section -->
                ...
                <div class="optionBox">
                    ...
                    <div class="tabOpt2 tabOption">
                        ...
                        <div class="tabOptSel">
                            ...
                            <a class="active" href="/board/newsletter.do">뉴스레터</a>
    ...
    <div class="board_view padding_tb">
        <div class="inner">
            <div class="board_view_box">
                <div class="board_view_tit">${newsletterInfo.title}</div>
                <div class="board_view_info">
                    <div class="write">${newsletterInfo.writer}</div>
                    <div class="date">
                        <c:set var="writeDate" value="${fn:replace(fn:split(newsletterInfo.writeDate,' ')[0],'-','.')}" />
                        ${writeDate}
                    </div>
                    <div class="count">${newsletterInfo.viewCnt}</div>
                </div>
                ...
                <div class="board_view_btn">
                    <c:if test="${newsletterInfo.prevId ne null and newsletterInfo.prevId ne ''}">
                        <a href="/board/newsletterView.do?id=${newsletterInfo.prevId}" class="prevBtn">이전글</a>
                    </c:if>
                    <a href="/board/newsletter.do" class="listBtn">목록</a>
                    <c:if test="${newsletterInfo.nextId ne null and newsletterInfo.nextId ne ''}">
                        <a href="/board/newsletterView.do?id=${newsletterInfo.nextId}" class="nextBtn">다음글</a>
                    </c:if>
                </div>
            </div>
        </div>
