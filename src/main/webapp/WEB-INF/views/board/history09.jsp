...
<div id="container">
    ...
    <div class="year_tab padding_t">
        <div class="inner">
            <div class="year_tab_box">
                ...
                <a href="/board/history09.do" class="active">2009</a>
    ...
    <div class="history_s history_s1">
        <div class="inner">
            ...
            <!-- 전시회개요 -->
            <div class="hist_info">
                <div class="poster"><img src="/img/img_history_2009.jpg"></div>
                <div class="hist_table">
                    <div class="table_box">
                        <table>
                            ...
                            <tr>
                                <td>전시명</td>
                                <td>2009 경기국제보트쇼 (Korea International Boat Show 2009)</td>
                            </tr>
                            <tr>
                                <td>개최일</td>
                                <td>2009.6.3(수) ~ 6.7(일)</td>
                            </tr>
                            <tr>
                                <td>규 모</td>
                                <td>관람객 : 237,000명 / 참가업체 467개 업체</td>
                            </tr>
                            <tr>
                                <td>장 소</td>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <div class="txt_box">
                            ...
                            <div class="txt"><span class="big">280</span><span class="small">개 업체</span></div>
                            <div class="cmnt">(국내 119+국외 161)</div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="txt_box">
                            ...
                            <div class="txt"><span class="big">187</span><span class="small">개 업체</span></div>
                        </div>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="swiper swiper_histPhoto">
                        <ul class="swiper-wrapper">
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2009_1b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2009_2b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2009_3b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2009_4b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2009_5b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2009_6b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2009_7b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2009_8b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2009_9b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2009_10b.jpg">
                                </div>
                            </li>
                        </ul>
                    </div>
