...
<div id="container">
    ...
    <div class="year_tab padding_t">
        <div class="inner">
            <div class="year_tab_box">
                ...
                <a href="/board/history14.do" class="active">2014</a>
    ...
    <div class="history_s history_s1">
        <div class="inner">
            ...
            <!-- 전시회개요 -->
            <div class="hist_info">
                <div class="poster"><img src="/img/img_history_2014.jpg"></div>
                <div class="hist_table">
                    <div class="table_box">
                        <table>
                            ...
                            <tr>
                                <td>전시명</td>
                                <td>해양안전 컨퍼런스 및 경기국제보트쇼 2014</td>
                            </tr>
                            <tr>
                                <td>개최일</td>
                                <td>2014.6.12(목) ~ 6.15(일)</td>
                            </tr>
                            <tr>
                                <td>규 모</td>
                                <td>22,500(㎡)</td>
                ...
                <ul>
                    <li>
                        ...
                        <div class="txt_box">
                            ...
                            <div class="txt"><span class="big">15</span><span class="small">개국</span></div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="txt_box">
                            ...
                            <div class="txt"><span class="big">206</span><span class="small">개 업체</span></div>
                            <div class="cmnt">(국내 182+국외 44)</div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="txt_box">
                            ...
                            <div class="txt"><span class="big">89</span><span class="small">개 업체</span></div>
                        </div>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="swiper swiper_histPhoto">
                        <ul class="swiper-wrapper">
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2014_1b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2014_2b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2014_3b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2014_4b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2014_5b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2014_6b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2014_7b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2014_8b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2014_9b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2014_10b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2014_11b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2014_12b.jpg">
                                </div>
                            </li>
                        </ul>
                    </div>
