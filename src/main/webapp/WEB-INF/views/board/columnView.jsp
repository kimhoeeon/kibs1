        ...
        <div class="inner">
            <div class="sub_top_box">
                <div class="sub_top_nav">
                    <span>홈</span><span>자료실</span><span>기사 및 칼럼</span>
                </div>
    ...
    <div class="board_view padding_tb">
        <div class="inner">
            <div class="board_view_box">
                <div class="board_view_tit">${columnInfo.title}</div>
                <div class="board_view_info">
                    <div class="write">${columnInfo.writer}</div>
                    <div class="date">
                        <c:set var="writeDate" value="${fn:replace(fn:split(columnInfo.writeDate,' ')[0],'-','.')}" />
                        ${writeDate}
                    </div>
                    <div class="count">${columnInfo.viewCnt}</div>
                </div>
                ...
                <div class="board_view_btn">
                    <c:if test="${columnInfo.prevId ne null and columnInfo.prevId ne ''}">
                        <a href="/board/columnView.do?id=${columnInfo.prevId}" class="prevBtn">이전글</a>
                    </c:if>
                    <a href="/board/column.do" class="listBtn">목록</a>
                    <c:if test="${columnInfo.nextId ne null and columnInfo.nextId ne ''}">
                        <a href="/board/columnView.do?id=${columnInfo.nextId}" class="nextBtn">다음글</a>
                    </c:if>
                </div>
            </div>
        </div>
