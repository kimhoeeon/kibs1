...
<div id="container">
    ...
    <div class="year_tab padding_t">
        <div class="inner">
            <div class="year_tab_box">
                ...
                <a href="/board/history19.do" class="active">2019</a>
    ...
    <div class="history_s history_s1  padding_b">
        <div class="inner">
            ...
            <!-- 전시회개요 -->
            <div class="hist_info">
                <div class="poster"><img src="/img/img_history_2019.png"></div>
                <div class="hist_table">
                    <div class="table_box">
                        <table>
                            ...
                            <tr>
                                <td>전시명</td>
                                <td>2019 경기국제보트쇼 (Korea International Boat Show 2019)</td>
                            </tr>
                            <tr>
                                <td>개최일</td>
                                <td>2019.5.9 - 5.12</td>
                    ...
                    <div class="btn_box">
                        <a href="/file/2019 보트쇼 현장리플렛.pdf" target="_blank" class="btnSt01">2019 경기국제보트쇼 한 눈에 보기</a>
                        <a href="/file/2019 보트쇼 현장리플렛.pdf" download class="btnSt01">2019 경기국제보트쇼 Show Guide
                            다운로드</a>
                    </div>
