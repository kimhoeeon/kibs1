...
<div id="container">
    ...
    <div class="year_tab padding_t">
        <div class="inner">
            <div class="year_tab_box">
                ...
                <a href="/board/history08.do" class="active">2008</a>
            </div>
        </div>
    </div>
    <!-- //section -->
    ...
    <div class="history_s history_s1">
        <div class="inner">
            ...
            <!-- 전시회개요 -->
            <div class="hist_info">
                <div class="poster"><img src="/img/img_history_2008.jpg"></div>
                <div class="hist_table">
                    <div class="table_box">
                        <table>
                            ...
                            <tr>
                                <td>전시명</td>
                                <td>2008 경기국제보트쇼 (Korea International Boat Show 2008)</td>
                            </tr>
                            <tr>
                                <td>개최일</td>
                                <td>2008.6.11(수) ~ 6.15(일)</td>
                            </tr>
                            <tr>
                                <td>규 모</td>
                                <td>관람객 : 350,000명 / 참가업체 430개 업체</td>
                            </tr>
                            <tr>
                                <td>장 소</td>
                ...
                <ul>
                    <li>
                        ...
                        <div class="txt_box">
                            ...
                            <div class="txt"><span class="big">22</span><span class="small">개국</span></div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="txt_box">
                            ...
                            <div class="txt"><span class="big">240</span><span class="small">개 업체</span></div>
                            <div class="cmnt">(국내 121+국외 119)</div>
                        </div>
                    </li>
                    <li>
                    ...
                    <div class="swiper swiper_histPhoto">
                        <ul class="swiper-wrapper">
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2008_1b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2008_2b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2008_3b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2008_4b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2008_5b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2008_6b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2008_7b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2008_8b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2008_9b.jpg">
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="thumb11 thumbBox"><img class="thumbImg" src="/img/photo2008_10b.jpg">
                                </div>
                            </li>
                        </ul>
                    </div>
