...
<div id="container">
    ...
    <div class="year_tab padding_t">
        <div class="inner">
            <div class="year_tab_box">
                ...
                <a href="/board/history21.do" class="active">2021</a>
    ...
    <div class="history_s history_s1  padding_b">
        <div class="inner">
            ...
            <!-- 전시회개요 -->
            <div class="hist_info">
                <div class="poster"><img src="/img/img_history_2021.png"></div>
                <div class="hist_table">
                    <div class="table_box">
                        <table>
                            ...
                            <tr>
                                <td>전시명</td>
                                <td>2021 경기국제보트쇼 온라인 전시관 (Korea International Boat Show 2021 On-Line)</td>
                            </tr>
                            <tr>
                                <td>개최일</td>
                                <td>2021. 10. 1(금) 개막 ~ 상시운영</td>
                            </tr>
                            <tr>
                                <td>규 모</td>
                                <td> kibs.com</td>
