...
<div id="container">
    ...
    <div class="sub_online_top online_tv_top">
        <div class="inner">
            <div class="online_top_tit">
                ...
                <div class="small">경기국제보트쇼에서 준비한 다양한 영상과 참가 기업 소개 영상을 시청할 수 있습니다</div>
            </div>
        </div>
    </div>
    <!-- //section -->
    ...
    <div class="tv_tab">
        <div class="inner">
            ...
            <div class="tv_cate">
                <a href="/online/kibstv.do">연도별 분류</a>
                <a href="/online/kibstv_cate.do" class="active">카테고리 분류</a>
            </div>
            <ul class="field">
                <li class="active">
                ...
                <li>
                    <a class="cate" data-value="부스투어" onclick="f_kibstv_category_search(this, '부스투어')" style="cursor: pointer">부스투어</a>
                </li>
                <li>
                    <a class="cate" data-value="해양레저 컨퍼런스" onclick="f_kibstv_category_search(this, '해양레저 컨퍼런스')" style="cursor: pointer">해양레저 컨퍼런스</a>
                </li>
                <li>
                    <a class="cate" data-value="숏츠" onclick="f_kibstv_category_search(this, '숏츠')" style="cursor: pointer">숏츠</a>
                </li>
                <li>
                    <a class="cate" data-value="마린리뷰쇼" onclick="f_kibstv_category_search(this, '마린리뷰쇼')" style="cursor: pointer">마린리뷰쇼</a>
                </li>
                <li>
                    <a class="cate" data-value="해양레저 다이어리" onclick="f_kibstv_category_search(this, '해양레저 다이어리')" style="cursor: pointer">해양레저 다이어리</a>
                </li>
                <li>
                    <a class="cate" data-value="보트클래스" onclick="f_kibstv_category_search(this, '보트클래스')" style="cursor: pointer">보트클래스</a>
                </li>
                <li>
                    <a class="cate" data-value="렛츠고 보트피싱" onclick="f_kibstv_category_search(this, '렛츠고 보트피싱')" style="cursor: pointer">렛츠고 보트피싱</a>
                </li>
                <li>
                    <a class="cate" data-value="참가기업 영상" onclick="f_kibstv_category_search(this, '참가기업 영상')" style="cursor: pointer">참가기업 영상</a>
                </li>
                <li>
                    <a class="cate" data-value="2018 이전 영상" onclick="f_kibstv_category_search(this, '2018 이전 영상')" style="cursor: pointer">2018 이전 영상</a>
                </li>
            </ul>
        </div>
    </div>
...
<script src="/js/front/kibstv.js?ver=20260630"></script>
</body>
</html>