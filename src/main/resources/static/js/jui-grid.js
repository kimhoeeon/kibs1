...
exports.default = {
    ...
    component: function component() {
        ...
        var UI = function UI() {
            var $obj = null,
                ddUi = null; // table/thead/tbody 구성요소, 칼럼 설정 UI (Dropdown)
            ...
            this.update = function () {
                ...
                if (index != null) {
                    ...
                    // 정렬 인덱스가 옵션에 있을 경우, 해당 인덱스의 칼럼 정렬
    ...
    component: function component() {
        ...
        var UI = function UI() {
            ...
            function setScrollWidthResize(self) {
                ...
                self.addEvent(document, "mouseup", function (e) {
                    if (resizeX > 0) {
                        // 마지막 칼럼 크기를 0보다 크게 리사이징시 가로 스크롤 위치 조정
                        if (column.isLast) {
            ...
            this.update = function (dataList) {
                ...
                // 정렬 인덱스가 옵션에 있을 경우, 해당 인덱스의 칼럼 정렬 (not loading)
                if (this.options.sortIndex) {
