...
function searchPosts(pageNum) {
    ...
    $.ajax({
        url: '/board/column/selectList.do',
        method: 'post',
    ...
    .done(function (data, status){
        ...
        $.each(results , function(i){
            ...
            str += '<li>';
                ...
                str += '<div class="tit" onClick="location.href=\'/board/columnView.do?id=' + id + '\'">';
                    str += title;
                str += '</div>';
                str += '<div class="write">';
                    str += writer;
