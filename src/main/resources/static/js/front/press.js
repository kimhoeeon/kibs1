    ...
    .done(function (data, status){
        ...
        $.each(results , function(i){
            ...
            if(noticeGbn === '1'){
                ...
                str += '<div class="tit" onClick="location.href=\'/board/pressView.do?id=' + id + '\'">';
                    str += title;
                str += '</div>';
                str += '<div class="write">';
                    str += writer;
        ...
        if(nvl(results,"") !== "") {
            ...
            emptyStr += '<li>';
            emptyStr += '<div>';
            emptyStr += '해당 조건으로 검색된 보도자료가 없습니다.';
            emptyStr += '</div>';
            emptyStr += '</li>';
