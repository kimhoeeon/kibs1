...
function f_application_sign_new_search(){
    ...
    let resData = ajaxConnect('/mng/exhibitorNew/application/sign/selectList.do', 'post', jsonObj);
    ...
    let jb = $('#kt_exhibitor_application_sign_new_table tbody td');
    let cnt = 0;
...
function f_application_sign_new_modify_init_set(id){
    window.location.href = '/mng/exhibitorNew/application/sign/detail.do?seq=' + id;
}
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            if(validCheck){
                ...
                $.ajax({
                    url: '/mng/exhibitorNew/application/sign/update.do',
                    method: 'POST',
                    async: false,
                    data: data,
                    dataType: 'json',
