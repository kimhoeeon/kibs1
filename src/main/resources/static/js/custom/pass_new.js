        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                if(nvl(seq,"") !== ""){
                    ...
                    let resData = ajaxConnect('/mng/exhibitorNew/application/pass/delete.do','post',jsonObj);
...
function f_application_pass_new_search(){
    ...
    let resData = ajaxConnect('/mng/exhibitorNew/application/pass/selectList.do', 'post', jsonObj);
...
function f_application_pass_new_modify_init_set(id){
    window.location.href = '/mng/exhibitorNew/application/pass/detail.do?seq=' + id;
}
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            if(validCheck){
                ...
                $.ajax({
                    url: '/mng/exhibitorNew/application/pass/update.do',
                    method: 'POST',
                    async: false,
                    data: data,
                    dataType: 'json',
