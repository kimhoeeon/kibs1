        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                if(nvl(seq,"") !== ""){
                    ...
                    let resData = ajaxConnect('/mng/exhibitorNewNew/application/gift/delete.do','post',jsonObj);
...
function f_application_gift_new_search(){
    ...
    let resData = ajaxConnect('/mng/exhibitorNewNew/application/gift/selectList.do', 'post', jsonObj);
...
function f_application_gift_new_modify_init_set(seq){
    window.location.href = '/mng/exhibitorNewNew/application/gift/detail.do?seq=' + seq;
}
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            if(validCheck){
                ...
                $.ajax({
                    url: '/mng/exhibitorNewNew/application/gift/update.do',
                    method: 'POST',
                    async: false,
                    data: data,
                    dataType: 'json',
