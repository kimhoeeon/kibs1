...
function f_application_online_new_search(){
    ...
    let resData = ajaxConnect('/mng/exhibitorNew/application/online/selectList.do', 'post', jsonObj);
...
function f_application_online_new_modify_init_set(id){
    window.location.href = '/mng/exhibitorNew/application/online/detail.do?seq=' + id;
}
    ...
    if(nvl(seq,"") === ""){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                let resData = ajaxConnect('/mng/exhibitorNew/application/online/updateViewYn.do', 'post', jsonObj);
