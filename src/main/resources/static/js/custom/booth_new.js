...
function f_application_booth_new_modify_init_set(id){
    window.location.href = '/mng/exhibitorNew/application/booth/detail.do?seq=' + id;
}
                ...
                success: function (data) {
                    if (data.resultCode === "0") {
                        ...
                        Swal.fire({
                            icon: 'info',
                            title: '[ 전시부스 정보 ]',
                            html: '<span style="font-size: 1.4em;">전시 부스 정보가 저장되었습니다.</span>',
                            allowOutsideClick: false,
                            confirmButtonColor: '#3085d6',
                            confirmButtonText: '확인'
                        }).then((result) => {
