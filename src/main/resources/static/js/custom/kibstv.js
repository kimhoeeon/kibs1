        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                if (resData.resultCode === "0") {
                    ...
                    showMessage('', 'error', '에러 발생', 'KIBS TV 삭제를 실패하였습니다. 관리자에게 문의해 주세요. ' + resData.resultMessage, '');
                }
            }
        });
    }
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.resultCode === "0") {
                                ...
                                showMessage('', 'error', '에러 발생', 'KIBS TV 정보 변경을 실패하였습니다. 관리자에게 문의해 주세요. ' + data.resultMessage, '');
                            }
                        },
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.resultCode === "0") {
                                ...
                                showMessage('', 'error', '에러 발생', 'KIBS TV 정보 등록을 실패하였습니다. 관리자에게 문의해 주세요. ' + data.resultMessage, '');
                            }
                        },
                        error: function (xhr, status) {
                            alert('오류가 발생했습니다. 관리자에게 문의해 주세요.\n오류명 : ' + xhr + "\n상태 : " + status);
