...
var KTWidgets = function () {
    ...
    let initChartsWidget3 = function() {
        let element = document.getElementById("kt_charts_widget_3_chart");
        ...
        let resetCssClasses = function(activeEl) {
            let els = document.querySelectorAll('.homepage-visit a')
        ...
        document.querySelector('#kt_charts_widget_3_month_btn')
            .addEventListener('click', function(e) {
                resetCssClasses(e);
                $.getJSON('/mng/main/statistics/accessor/month.do', function(response) {
                    chart.self.updateSeries([{
                        name: '방문자 수 ',
                        data: response
                    }])
        ...
        document.querySelector('#kt_charts_widget_3_week_btn')
            .addEventListener('click', function(e) {
                resetCssClasses(e);
                $.getJSON('/mng/main/statistics/accessor/week.do', function(response) {
                    chart.self.updateSeries([{
        ...
        document.querySelector('#kt_charts_widget_3_day_btn')
            .addEventListener('click', function(e) {
                resetCssClasses(e);
    ...
    let initChartsWidget4 = function() {
        let element = document.getElementById("kt_charts_widget_4_chart");
        ...
        let initChart = function() {
            ...
            let baseLightColor = KTUtil.getCssVariableValue('--bs-success-light');
            let secondaryColor = KTUtil.getCssVariableValue('--bs-warning');
            let secondaryLightColor = KTUtil.getCssVariableValue('--bs-warning-light');
            ...
            $.getJSON('/mng/main/statistics/participant/week.do', function(response) {
                chart.self.updateSeries([
                    {
                        name: "참가기업 ",
        ...
        let resetCssClasses = function(activeEl) {
            let els = document.querySelectorAll('.participant-stat a')
            Array.prototype.forEach.call(els, function(el) {
                el.classList.remove('active');
            })
        ...
        document.querySelector('#kt_charts_widget_4_month_btn')
            .addEventListener('click', function(e) {
                resetCssClasses(e);
                $.getJSON('/mng/main/statistics/participant/month.do', function(response) {
                    chart.self.updateSeries([
                        {
                            name: "참가기업 ",
                            data: response[0].data
        ...
        document.querySelector('#kt_charts_widget_4_week_btn')
            .addEventListener('click', function(e) {
                resetCssClasses(e);
                $.getJSON('/mng/main/statistics/participant/week.do', function(response) {
                    chart.self.updateSeries([
        ...
        document.querySelector('#kt_charts_widget_4_day_btn')
            .addEventListener('click', function(e) {
                resetCssClasses(e);
                $.getJSON('/mng/main/statistics/participant/day.do', function(response) {
                    chart.self.updateSeries([
                        {
                            name: "참가기업 ",
                            data: response[0].data
